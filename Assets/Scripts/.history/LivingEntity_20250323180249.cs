...
public class LivingEntity : MonoBehaviour
{
    ...
    // Modify the Die method to call our new coroutine
    public void Die(GameObject killer = null)
    {
        ...
        // If this should be destroyed, start the countdown (handled in ForceDeathAnimationByReplacement)
        // We don't need this here since the coroutine handles destruction
        ...
        // Only do the sinking effect for non-player entities
        if (!killedByPlayer)
        {
