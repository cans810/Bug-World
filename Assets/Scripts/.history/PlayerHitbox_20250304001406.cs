...
public class PlayerHitbox : MonoBehaviour
{
    ...
    private IEnumerator PerformAttack()
    {
        ...
        if (animController != null)
        {
            // Simply set attacking to true without affecting other animations
            animController.SetAttacking(true);
            
            if (showDebugMessages)
            {
                Debug.Log("Started attack animation (head only)");
            }
        }
    ...
    private void StopAttacking()
    {
        ...
        if (animController != null)
        {
            // Simply set attacking to false without affecting other animations
            animController.SetAttacking(false);
            
            if (showDebugMessages)
            {
                Debug.Log("Stopped attack animation (head only)");
            }
        }
