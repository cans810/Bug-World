...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator ReviveAfterDelay(float delay)
    {
        ...
        // Temporarily disable auto-attack
        bool previousAutoAttackState = autoAttackEnabled;
        autoAttackEnabled = false;
        
        // Clear any targets in the LivingEntity component
        if (livingEntity != null)
        {
            livingEntity.ClearAllTargets();
        }
        ...
        if (livingEntity != null)
        {
            ...
            livingEntity.SetTemporaryInvulnerability(3f); // Increased to 3 seconds of invulnerability
        }
        
        // Wait a moment before re-enabling auto-attack (if it was enabled before)
        yield return new WaitForSeconds(2f);
        autoAttackEnabled = previousAutoAttackState;
    }
