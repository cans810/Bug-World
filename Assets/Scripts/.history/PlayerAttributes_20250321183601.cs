...
public class PlayerAttributes : MonoBehaviour
{
    ...
    // Add these fields near the other attributes
    [SerializeField] private int speedPoints = 0;
    [SerializeField] private int maxSpeedPoints = 25;
    [SerializeField] private float speedPercentagePerPoint = 0.01f; // 1% per point
    
    // Add this property
    public int SpeedPoints => speedPoints;
    public int MaxSpeedPoints => maxSpeedPoints;
    public float SpeedMultiplier => 1f + (speedPoints * speedPercentagePerPoint);
    ...
    {
        if (availablePoints <= 0 || speedPoints >= maxSpeedPoints)
            return false;
        ...
        Debug.Log($"Increased Speed to {speedPoints}. SpeedMultiplier: {SpeedMultiplier:F2}x");
        return true;
    }
    ...
    public void SetAttributeValues(int strength, int vitality, int agility, int incubation, int recovery, int speed, int availablePoints)
    {
        ...
        Debug.Log($"Directly set attribute values: Strength={strength}, Vitality={vitality}, " +
                  ...
                  $"Speed={speed}, Points={availablePoints}");
    }
    ...
    public void SavePlayerAttributes(GameData saveData)
    {
        ...
        saveData.currentSpeed = speedPoints;
    ...
    public void LoadPlayerAttributes(GameData saveData)
    {
        ...
        try
        {
            ...
            speedPoints = saveData.currentSpeed;
