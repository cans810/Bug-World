    ...
    private IEnumerator SpawnAndAnimateChitinIcons(int chitinCount)
    {
        ...
        for (int i = 0; i < allIcons.Count; i++)
        {
            ...
            while (timer < duration)
            {
                ...
                float easedT = Mathf.SmoothStep(0, 1, t); // Add easing for smoother motion
                ...
                newPos.y += 80f * Mathf.Sin(t * Mathf.PI); // Higher arc for more dramatic effect
