...
public class AllyAI : MonoBehaviour
{
    ...
    private void WanderBehavior()
    {
        ...
        // Check if the wandering behavior is actually moving the entity
        if (wanderingBehavior != null && wanderingBehavior.IsMoving())
        {
            // Update animation to walking if we're moving
            isMoving = true;
            UpdateAnimation(true);
        }
        else
