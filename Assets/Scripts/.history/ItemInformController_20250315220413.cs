...
public class ItemInformController : MonoBehaviour
{
    ...
    [Header("Chitin Info")]
    [SerializeField] private string chitinDescription = "Chitin! Is used to gain xp, level up, and upgrade your attributes. It can be collected from defeated enemies.";
    [SerializeField] private Sprite chitinSprite;
    
    [Header("Crumb Info")]
    [SerializeField] private string crumbDescription = "Crumb! are a food resource that provides energy to your colony. Collect them from various locations in the world.";
