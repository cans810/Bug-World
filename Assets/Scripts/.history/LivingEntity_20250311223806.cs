...
public class LivingEntity : MonoBehaviour
{
    ...
    // Add this method to play attack sound
    ...
    // Add this method to play hit sound
    ...
    // Modify the DealDamage method to play sound on successful hit
    private void DealDamage()
    {
        ...
        foreach (Collider hitCollider in hitColliders)
        {
            ...
            if (targetEntity != null && !targetEntity.IsDead)
            {
                ...
                // Optional: Add visual effects, camera shake, etc.
            }
        }
        
        // Play attack sound if we hit something
        if (hitSomething)
        {
            PlayAttackSound();
        }
