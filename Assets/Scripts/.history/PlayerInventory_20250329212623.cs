...
public class PlayerInventory : MonoBehaviour
{
    ...
    // Update the AddXP method in PlayerInventory.cs to ensure proper level-up sequence
    public void AddXP(int amount)
    {
        ...
        if (newLevel > oldLevel)
        {
            ...
            // Trigger level up UI
            TriggerLevelUpSequence(newLevel);
        }
    ...
    // Add this method to trigger the level up sequence
    private void TriggerLevelUpSequence(int newLevel)
    {
        Debug.Log($"Triggering level up sequence for level {newLevel}");
        ...
        // Show the level up panel with appropriate rewards
        LevelUpPanelHelper levelUpPanel = FindObjectOfType<LevelUpPanelHelper>();
        if (levelUpPanel != null)
        {
            levelUpPanel.ShowUpperPanel();
        }
