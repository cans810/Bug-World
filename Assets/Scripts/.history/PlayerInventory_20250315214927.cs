...
public class PlayerInventory : MonoBehaviour
{
    ...
    [SerializeField] private bool hasCollectedChitinFirstTime = false;
    [SerializeField] private bool hasCollectedCrumbFirstTime = false;
    ...
    public bool HasCollectedChitinFirstTime { get => hasCollectedChitinFirstTime; set => hasCollectedChitinFirstTime = value; }
    public bool HasCollectedCrumbFirstTime { get => hasCollectedCrumbFirstTime; set => hasCollectedCrumbFirstTime = value; }
    ...
    public bool AddCrumb(int amount)
    {
        ...
        if (!hasCollectedCrumbFirstTime)
        {
            hasCollectedCrumbFirstTime = true;
            ...
            if (uiHelper != null && uiHelper.ItemInformPanel != null)
            {
                ...
                {
                    // No fallback needed as we're just showing the panel through the controller
    ...
    {
        // Check if this is the first time collection
        if (!hasCollectedChitinFirstTime)
        {
            Debug.Log("FIRST TIME collecting chitin! Attempting to show info panel...");
            hasCollectedChitinFirstTime = true;
