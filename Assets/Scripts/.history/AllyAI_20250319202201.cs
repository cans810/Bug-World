...
public class AllyAI : MonoBehaviour
{
    ...
    private Vector3 GetPlayerVelocity()
    {
        ...
        else
        {
            ...
            if (controller != null)
            {
                // Use GetMovementDirection() and access livingEntity.moveSpeed directly
                Vector3 direction = controller.GetMovementDirection();
                
                // Try to get the player's LivingEntity component for speed
                LivingEntity playerLivingEntity = playerTransform.GetComponent<LivingEntity>();
                float speed = (playerLivingEntity != null) ? playerLivingEntity.moveSpeed : 2.0f;
