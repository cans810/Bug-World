...
public class CameraAnimations : MonoBehaviour
{
    ...
    private IEnumerator AnimateCameraToNewInsect(Transform insectTransform)
    {
        ...
        // Calculate position to view the insect from
        ...
        Vector3 viewPosition = insectPosition + offsetDirection * 1.5f; // Side view, not too far
        viewPosition.y = insectPosition.y + 1f; // Slightly above the insect
        
        // Calculate rotation to look at the insect
