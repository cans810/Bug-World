...
public class AllyAI : MonoBehaviour
{
    ...
    private void CarryLootToBase()
    {
        ...
        // ULTRA SIMPLE STRAIGHT LINE MOVEMENT:
        // Create a vector directly from ally to base (X and Z only)
        ...
        // Apply movement directly with constant speed
        transform.position = Vector3.MoveTowards(
            transform.position,
            targetPosition,
            livingEntity.moveSpeed * Time.deltaTime
        );
    }
