...
public class ArrowIndicator : MonoBehaviour
{
    ...
    [SerializeField] private float arrowScale = 0.7f; // Reduced from default
    ...
    [SerializeField] private bool autoHideWhenClose = false; // Make this configurable
    ...
    private void Update()
    {
        if (arrowInstance != null && targetObject != null && playerTransform != null)
        {
            ...
            // Only hide arrow if autoHideWhenClose is enabled
            if (autoHideWhenClose)
            {
    ...
    // Add this method to control auto-hiding behavior
    public void SetAutoHideWhenClose(bool autoHide)
    {
        autoHideWhenClose = autoHide;
    }
