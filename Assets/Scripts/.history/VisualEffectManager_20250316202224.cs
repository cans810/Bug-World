...
public class VisualEffectManager : MonoBehaviour
{
    ...
    public void PlayXPGainEffect(Vector3 nestPosition, int xpAmount)
    {
        ...
        // Calculate number of symbols - 2 per chitin (xpAmount / 2 = number of chitins)
        int chitinCount = xpAmount / 2;
        int symbolCount = chitinCount * 2;
        
        // Log the calculated values
        Debug.Log($"Calculated chitinCount: {chitinCount}, symbolCount: {symbolCount}");
