...
public class ChitinDropper : MonoBehaviour
{
    ...
    // Add this method to visualize the drop area in the Scene view
    private void OnDrawGizmos()
    {
        ...
        // Draw a sphere to represent the spawn area
        ...
        UnityEditor.Handles.Label(dropPosition + Vector3.up * 0.5f, "Chitin Drop Area");
        #endif
    }
