...
public class MissionManager : MonoBehaviour
{
    ...
    private void RemoveMissionPanel(string missionId)
    {
        ...
        if (panelToRemove != null)
        {
            ...
            // Play the Hide animation and then destroy the panel
    ...
    /// <summary>
    /// Awards rewards to the player when a mission is completed
    /// </summary>
    private void AwardRewards(MissionData mission)
    {
        // Implementation of awarding rewards
        Debug.Log($"Rewards awarded: Coins={mission.coinReward}, XP={mission.xpReward}");
        
        // Find the PlayerInventory component to award XP and coins
