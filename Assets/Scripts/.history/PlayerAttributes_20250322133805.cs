...
public class PlayerAttributes : MonoBehaviour
{
    ...
    public void RecalculateAvailablePoints()
    {
        ...
        // IMPORTANT: Don't recalculate from scratch, only add points if needed
        // Check if we need to add points based on level changes
        ...
        // Calculate how many points the player should have in total
        int expectedTotal = levelBasedPoints;
        
        // If the player has fewer available points than expected, add the difference
        if (availablePoints + spentPoints < expectedTotal)
        {
            int pointsToAdd = expectedTotal - (availablePoints + spentPoints);
            availablePoints += pointsToAdd;
            
            Debug.Log($"RecalculateAvailablePoints: Adding {pointsToAdd} missing points. " +
                      $"New total: {availablePoints}");
        }
