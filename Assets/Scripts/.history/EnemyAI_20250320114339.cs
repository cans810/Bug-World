...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] public bool avoidMapBorders = true;
    [SerializeField] public float borderAvoidanceDistance = 0f;
    [SerializeField] public string borderLayerName = "MapBorder";
    [SerializeField] public string borderObjectName = "Map Border";
