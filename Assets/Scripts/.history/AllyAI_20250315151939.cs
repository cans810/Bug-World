...
public class AllyAI : MonoBehaviour
{
    ...
    [Header("Controls")]
    [SerializeField] private OnScreenJoystick joystick; // Add reference to joystick
    ...
    {
        // Skip if we can't find joystick
        if (joystick == null)
        {
            joystick = FindObjectOfType<OnScreenJoystick>();
            if (joystick == null)
        ...
        // Get input from joystick (same as PlayerController)
        float horizontal = 0f;
        float vertical = 0f;
        ...
        // If we have input, move the ally
