...
public class AllyAI : MonoBehaviour
{
    ...
    private void FollowPlayerBehavior()
    {
        ...
        // Use different follow distances based on player movement
        float effectiveFollowDistance = isPlayerMoving ? followDistance : playerStationaryStopDistance;
        ...
        else
        {
            ...
            // Use same movement method as enemy - move in the forward direction
    ...
    private void FaceTarget(Vector3 target)
    {
        ...
        {
            livingEntity.RotateTowards(directionToTarget, rotationMultiplier * 0.8f);
        }
    }
