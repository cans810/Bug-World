...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void DepositChitinAtBase(int amount)
    {
        ...
        {
            Debug.LogWarning($"Cannot deposit chitins: amount={amount}, current count={ChitinCount}");
            return;
        }
        ...
        Debug.Log($"Depositing {amount} chitins at base (current count: {ChitinCount})");
        ...
        {
            Debug.LogWarning("Could not find UIHelper for chitin deposit animation");
        }
        ...
        // Log the deposit
        Debug.Log($"Deposited {amount} chitins, gained {xpGained} XP");
    }
