...
public class VisualEffectManager : MonoBehaviour
{
    ...
    public void PlayLevelUpEffect(Vector3 playerPosition, System.Action onCompleteCallback = null)
    {
        ...
        if (shineSymbolPrefab != null)
        {
            ...
            // Set scale (make it smaller - just 1.0x base scale instead of 2.0x)
            Vector3 originalShineScale = baseScale * 1.0f; // Use normal size instead of twice as large
            ...
            // Animate the shine
            StartCoroutine(AnimateShineSymbol(shineSymbol, originalShineScale));
        }
    ...
    // New method to animate the shine symbol
    private IEnumerator AnimateShineSymbol(GameObject shineSymbol, Vector3 originalScale)
    {
        if (shineSymbol == null) yield break;
        ...
        while (elapsed < duration)
        {
            ...
            // Grow gradually to 3x original size
            float growMultiplier = Mathf.Lerp(1.0f, 3.0f, normalizedTime);
