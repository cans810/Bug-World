...
public class UIHelper : MonoBehaviour
{
    ...
    public void UpdateAllResourceDisplays()
    {
        ...
        // For egg count, use a simple fallback value since we're not sure of the correct property
        int eggCount = 0; // Default to 0
        
        // We've tried EggCount and GetEggs() without success, so let's just use the default
