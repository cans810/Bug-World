...
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] private Color activeColor = new Color(1f, 1f, 1f, 0.5f);
    ...
    public void SetBackgroundTransparency(float alpha)
    {
        ...
        // Update colors
        normalColor.a = alpha;
        activeColor.a = alpha + 0.2f; // Make active slightly more visible
        
        // Apply to current state
        if (backgroundImage != null)
        {
            Color currentColor = backgroundImage.color;
            currentColor.a = isDragging ? activeColor.a : normalColor.a;
