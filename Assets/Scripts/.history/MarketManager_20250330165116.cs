        ...
        if (productId == "doubleThreat")
        {
            ...
            if (incubator != null)
            {
                ...
                if (!hasSpace)
                {
                    ...
                    // Return Complete to acknowledge purchase
                    return PurchaseProcessingResult.Complete;
                }
                
                // If we have enough space, create the eggs
                bool success = incubator.CreateMultipleEggs("scorpion", 2);
                GameObject eggCreated = GameObject.Find("AntEggPile"); // Get any egg to show in animation
                ...
                else
                {
                    ...
                    Debug.LogError("Double Threat purchase: Failed to create/find eggs");
