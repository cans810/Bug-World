...
public class UIHelper : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 cooldownTextOffset = new Vector2(0, 10); // Reduced from 30 to 10
    ...
    private void UpdateCooldownTextPosition()
    {
        ...
        // Get position at bottom of player (reduced offset from -0.5f to -0.3f)
        Vector3 playerPos = player.transform.position + new Vector3(0, -0.3f, 0);
