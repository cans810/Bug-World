...
public class GameManager : MonoBehaviour
{
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (playerAttributes != null)
        {
            ...
            // Set attribute points - fix the field names to match PlayerAttributes class
            SetPrivateField(playerAttributes, "strength.points", gameData.currentStrength);
            SetPrivateField(playerAttributes, "vitality.points", gameData.currentVitality);
            SetPrivateField(playerAttributes, "agility.points", gameData.currentAgility);
            SetPrivateField(playerAttributes, "incubationPoints", gameData.currentIncubation);
            
            Debug.Log($"Setting attributes - Strength: {gameData.currentStrength}, Vitality: {gameData.currentVitality}, " +
                      $"Agility: {gameData.currentAgility}, Incubation: {gameData.currentIncubation}");
