...
public class GameManager : MonoBehaviour
{
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        {
            // Find and destroy all rock barriers
    ...
    // Add this helper method to remove rock barriers after a short delay
    private IEnumerator RemoveRockBarriersAfterDelay()
    {
        // Wait a short time to ensure all barriers are loaded
        yield return new WaitForSeconds(0.5f);
        
        // Find all barrier controllers
        BarrierRocksController[] rockBarriers = FindObjectsOfType<BarrierRocksController>();
        
        Debug.Log($"Removing {rockBarriers.Length} rock barriers based on saved game state");
