...
public class LivingEntity : MonoBehaviour
{
    ...
    public virtual void Die(GameObject killer = null)
    {
        ...
        // Determine entity type from GameObject name
        string entityName = gameObject.name;
        string cleanName = System.Text.RegularExpressions.Regex.Replace(entityName, @"\d+", "").Trim();
        
        // Notify MissionManager about this entity's death
        if (MissionManager.Instance != null)
        {
            MissionManager.Instance.OnEntityKilled(cleanName.ToLower());
