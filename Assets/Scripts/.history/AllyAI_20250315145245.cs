    ...
    private void FollowPlayerBehavior()
    {
        ...
        if (Time.time > lastPlayerVelocityCheckTime + playerVelocityCheckInterval)
        {
            ...
            if (lastPlayerPosition != Vector3.zero)
            {
                ...
                {
                    playerIsMoving = true;
                    playerMovementDirection = playerMovement.normalized;
                }
            }
        ...
        else
        {
            ...
            // Use player's movement direction if available, otherwise move directly toward player
            Vector3 moveDirection = playerMovementDirection.magnitude > 0.1f ? 
