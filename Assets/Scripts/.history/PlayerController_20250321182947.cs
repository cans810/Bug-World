...
public class PlayerController : MonoBehaviour
{
    ...
    public void SetCurrentBorder(string borderName, int requiredLevel, Vector3 borderPosition)
    {
        ...
        // Additional logic for handling border entry
        // ...
        
        // Optional: Inform UI or other systems about the border
    ...
    {
        // Don't change the current border name since player can't actually enter
