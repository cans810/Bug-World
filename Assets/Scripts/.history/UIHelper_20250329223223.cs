...
public class UIHelper : MonoBehaviour
{
    ...
    // Modified pulse effect that doesn't change color
    private IEnumerator PulseEffect(Image barImage)
    {
        // Store original scale
        Vector3 originalScale = barImage.transform.localScale;
        Vector3 pulseScale = originalScale * 1.1f; // Increase scale by 10%
        ...
        while (elapsed < halfDuration)
        {
            ...
            // Lerp from original to pulse scale
            barImage.transform.localScale = Vector3.Lerp(originalScale, pulseScale, t);
        ...
        while (elapsed < halfDuration)
        {
            ...
            // Lerp from pulse back to original scale
            barImage.transform.localScale = Vector3.Lerp(pulseScale, originalScale, t);
