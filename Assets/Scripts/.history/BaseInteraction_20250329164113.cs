...
public class BaseInteraction : MonoBehaviour
{
    ...
    private IEnumerator PlayXPGainAfterChitinDeposit(int xpAmount, int startXP, int targetXP)
    {
        if (visualEffectManager != null)
        {
            ...
            // Play the canvas-based animation sequence
            visualEffectManager.PlayCanvasChitinAnimation(chitinAmount, xpAmount);
        ...
        {
            // Fallback if visual effect manager isn't available
