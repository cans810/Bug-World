...
public class BaseInteraction : MonoBehaviour
{
    ...
    private IEnumerator PlayXPGainAfterChitinDeposit(int xpAmount, int startXP, int targetXP)
    {
        ...
        if (visualEffectManager != null)
        {
            ...
            visualEffectManager.PlayXPGainEffect(transform.position, xpAmount, startXP, targetXP);
    ...
    private IEnumerator DepositChitinWithAnimation(int amount)
    {
        // Disable player movement during deposit animation
        ...
        // Original deposit animation code...
