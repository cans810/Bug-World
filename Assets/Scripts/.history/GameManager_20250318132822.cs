    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (playerAttributes != null)
        {
            ...
            playerAttributes.SetAttributeValues(
                gameData.strengthPoints,
                gameData.vitalityPoints,
                gameData.agilityPoints,
                gameData.incubationPoints,
                gameData.availableAttributePoints
            );
            
            Debug.Log($"Set attribute values directly: Strength={gameData.strengthPoints}, " +
                      $"Vitality={gameData.vitalityPoints}, Agility={gameData.agilityPoints}, " +
                      $"Incubation={gameData.incubationPoints}, AvailablePoints={gameData.availableAttributePoints}");
