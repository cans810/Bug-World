...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        // If we have movement input, update rotation using the optimized method
        if (moveDirection.magnitude > 0.1f && livingEntity != null)
        {
            livingEntity.RotateTowards(moveDirection);
        }
