...
public class UIHelper : MonoBehaviour
{
    ...
    private void UpdateCooldownTextPosition()
    {
        ...
        // Get position closer to player's head (reduced Y offset from 2f to 1.2f)
        Vector3 playerPos = player.transform.position + new Vector3(0, 1.2f, 0);
        ...
        if (textRect != null)
        {
            ...
            // Use Vector3.Lerp to smooth the position transition and prevent flickering
            textRect.position = Vector3.Lerp(textRect.position, new Vector3(screenPos.x, screenPos.y, 0), Time.deltaTime * 10f);
        }
    }
