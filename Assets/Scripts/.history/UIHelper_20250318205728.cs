...
public class UIHelper : MonoBehaviour
{
    ...
    private System.Collections.IEnumerator AnimateChitinCount()
    {
        ...
        // Store original scale, don't rely on a field that might be incorrect
        Vector3 originalScale = countTextRect.localScale;
        ...
        // Ensure final scale is correct at the end of animation
    ...
    private System.Collections.IEnumerator AnimateCrumbCount()
    {
        ...
        // Store original scale, don't rely on a field that might be incorrect
        Vector3 originalScale = crumbTextRect.localScale;
        Vector3 targetScale = originalScale * 1.4f;
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            crumbTextRect.localScale = Vector3.Lerp(originalScale, targetScale, progress);
            yield return null;
        }
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            crumbTextRect.localScale = Vector3.Lerp(targetScale, originalScale, progress);
            yield return null;
        }
        
        // Ensure final scale is correct at the end of animation
        crumbTextRect.localScale = originalScale;
    }
    ...
    private System.Collections.IEnumerator AnimateXPText()
    {
        ...
        // Store original scale, don't rely on a field that might be incorrect
        Vector3 originalScale = xpTextRect.localScale;
        Vector3 targetScale = originalScale * 1.4f;
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            xpTextRect.localScale = Vector3.Lerp(originalScale, targetScale, progress);
            yield return null;
        }
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            xpTextRect.localScale = Vector3.Lerp(targetScale, originalScale, progress);
            yield return null;
        }
        
        // Ensure final scale is correct at the end of animation
        xpTextRect.localScale = originalScale;
    }
    ...
    private System.Collections.IEnumerator AnimateEggCount()
    {
        ...
        // Store original scale, don't rely on a field that might be incorrect
        Vector3 originalScale = eggTextRect.localScale;
        Vector3 targetScale = originalScale * 1.4f;
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            eggTextRect.localScale = Vector3.Lerp(originalScale, targetScale, progress);
            yield return null;
        }
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            eggTextRect.localScale = Vector3.Lerp(targetScale, originalScale, progress);
            yield return null;
        }
        
        // Ensure final scale is correct at the end of animation
        eggTextRect.localScale = originalScale;
    }
    ...
    private System.Collections.IEnumerator AnimateCoinCount()
    {
        ...
        // Store original scale, don't rely on a field that might be incorrect
        Vector3 originalScale = coinTextRect.localScale;
        Vector3 targetScale = originalScale * 1.4f;
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            coinTextRect.localScale = Vector3.Lerp(originalScale, targetScale, progress);
            yield return null;
        }
        ...
        while (timer < animationDuration / 2)
        {
            timer += Time.deltaTime;
            float progress = timer / (animationDuration / 2);
            coinTextRect.localScale = Vector3.Lerp(targetScale, originalScale, progress);
            yield return null;
        }
        
        // Ensure final scale is correct at the end of animation
        coinTextRect.localScale = originalScale;
    }
} 
