...
public class AttributeDisplay : MonoBehaviour
{
    ...
    // Add this failsafe method to directly show the panel without any checks
    public void ForceShowPanel()
    {
        Debug.Log("AttributeDisplay: ForceShowPanel called - bypassing all safety checks");
        ...
        if (attributesPanel != null)
        {
            ...
            // Then set animation parameters if needed
            if (panelAnimator != null)
            {
                panelAnimator.SetBool("ShowUp", true);
                panelAnimator.SetBool("Hide", false);
            ...
            Debug.Log("AttributeDisplay: Panel forcibly shown");
        }
        else
        {
            Debug.LogError("AttributeDisplay: attributesPanel is null in ForceShowPanel!");
        }
    }
} 