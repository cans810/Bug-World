...
public class EnemyAI : MonoBehaviour
{
    ...
    // Helper method to update animations - simplified to work with available methods
    private void UpdateAnimation(bool isWalking)
    {
        if (animController != null)
        {
            // Just set the walking state - the AnimationController should handle the idle state internally
