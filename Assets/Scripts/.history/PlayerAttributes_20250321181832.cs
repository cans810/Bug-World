...
public class PlayerAttributes : MonoBehaviour
{
    ...
    private const int maxSpeedPoints = 25; // Maximum of 25 points as requested
    public int SpeedPoints => speedPoints;
    public int MaxSpeedPoints => maxSpeedPoints;

    // Add this getter for the multiplier (1% per point)
    public float SpeedMultiplier => 1f + (speedPoints * 0.01f);
    ...
    public bool IncreaseSpeed()
    {
        ...
        Debug.Log($"Speed increased to {speedPoints}/{maxSpeedPoints}. Available points: {availablePoints}");
    ...
    // Add this method to allow setting speed points when loading a save
    public void SetSpeedPoints(int points)
    {
        speedPoints = Mathf.Clamp(points, 0, maxSpeedPoints);
        Debug.Log($"Speed points set to {speedPoints}");
        
        // Don't invoke events here as loading typically sets multiple attributes at once
    }
} 