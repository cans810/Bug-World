...
public class LivingEntity : MonoBehaviour
{
    ...
    // Add this field to the top of the LivingEntity class with other fields
    [SerializeField] private bool useCustomDeathAnimation = true;
    ...
    public virtual void Die(GameObject killer = null)
    {
        ...
        // Record the entity discovery when it dies
        ...
        if (useCustomDeathAnimation)
        {
            // Don't do anything else - let the enemy AI handle destruction
            // after custom animations are done
        }
        else
        {
