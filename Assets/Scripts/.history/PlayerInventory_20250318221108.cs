...
public class PlayerInventory : MonoBehaviour
{
    ...
    // Add this public method to PlayerInventory to allow manual level up checking
    public void CheckAndTriggerLevelUp()
    {
        ...
        if (newLevel > CurrentLevel)
        {
            ...
            _currentLevel = newLevel; // Use the backing field instead of the property
            ...
            // Add attribute points based on level up
            PlayerAttributes playerAttributes = FindObjectOfType<PlayerAttributes>();
            if (playerAttributes != null)
            {
                // Directly modify the public availablePoints field
                playerAttributes.availablePoints += playerAttributes.pointsPerLevel;
                
                // Call a public method to notify of attribute changes instead of invoking event directly
                // Look for any method in PlayerAttributes that might be used to notify of changes
                // Examples: UpdateAttributes(), NotifyAttributesChanged(), etc.
                Debug.Log($"Added {playerAttributes.pointsPerLevel} attribute points. New total: {playerAttributes.availablePoints}");
                
                // This works because attributes will be displayed when the panel shows
            }
