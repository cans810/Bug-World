...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private float surfaceAdhesionForce = 50f; // Increased from 20f to 50f
    
    [Header("Gravity Settings")]
    [SerializeField] private float gravityForce = 30f; // Increased gravity force
    [SerializeField] private float slopeGravityMultiplier = 5f; // Increased from 2f to 5f
    ...
    private void Start()
    {
        ...
        if (rb != null)
        {
            ...
            rb.mass = 1f; // Make sure mass is reasonable
            rb.drag = 1f; // Add some drag to prevent sliding
        }
    }
    ...
    private void ApplySurfaceAdhesion()
    {
        if (isGrounded)
        {
            ...
            // Apply a stronger force along the surface in the direction of the slope
        ...
        {
            // When not on a surface, apply stronger gravity
