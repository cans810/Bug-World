...
public class UIHelper : MonoBehaviour
{
    ...
    // Add this method to UIHelper
    public void DebugFullSaveLoadCycle()
    {
        Debug.Log("=== STARTING FULL SAVE/LOAD CYCLE TEST ===");
        ...
        if (gameManager != null)
        {
            ...
            if (loadedData != null)
            {
                Debug.Log("=== VERIFICATION OF SAVED DATA ===");
                Debug.Log($"Level: {loadedData.currentLevel}");
                Debug.Log($"XP: {loadedData.currentXP}");
                Debug.Log($"Chitin: {loadedData.currentChitin}");
                Debug.Log($"Crumb: {loadedData.currentCrumb}");
                ...
                // Show values after loading
                Debug.Log("=== VALUES AFTER LOADING ===");
                DebugShowCurrentValues();
            }
        }
        
        Debug.Log("=== FULL SAVE/LOAD CYCLE TEST COMPLETE ===");
    }
} 
