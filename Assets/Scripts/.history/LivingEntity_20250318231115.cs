...
public class LivingEntity : MonoBehaviour
{
    ...
    private void RecordEntityDiscovery()
    {
        ...
        if (entitiesController != null)
        {
            ...
            entitiesController.SetEntityDiscovered(entityType, true);
            
            // Also save to the GameManager
            GameManager gameManager = FindObjectOfType<GameManager>();
            if (gameManager != null)
            {
                gameManager.SetEntityDiscovered(entityType, true);
                
                // Force a save to ensure this discovery is saved
                gameManager.SaveGame();
                
                Debug.Log($"Discovered and saved entity: {entityType}");
            }
        }
    }
}