...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator UpdateCooldownTimerText(float initialCooldown)
    {
        ...
        while (remainingCooldown > 0)
        {
            ...
            // Use the dedicated attack cooldown text instead of the general inform text
            uiHelper.ShowAttackCooldownText($"Attack on cooldown! Ready in {cooldownText}s");
        ...
        if (enabled && livingEntity != null && !livingEntity.IsDead)
        {
            ...
            // The attack cooldown text will auto-hide from the ShowAttackCooldownText method
