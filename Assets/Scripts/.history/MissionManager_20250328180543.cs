        ...
        if (mission.CheckIsCompleted() && panel != null)
        {
            ...
            if (panelButton != null)
            {
                ...
                if (buttonText != null)
                {
                    ...
                    // Optional: Add a bold outline to make it pop more
                    if (buttonText.TryGetComponent<Outline>(out var outline))
                    {
                        outline.enabled = true;
                        outline.effectColor = new Color(0.5f, 0.3f, 0);  // Dark orange/brown outline
                        outline.effectDistance = new Vector2(1, -1);     // Shadow effect
                    }
                }
            }
        }
