...
public class AllyAI : MonoBehaviour
{
    ...
    {
        // Ensure consistent speed so wandering works properly
        EnsureConsistentSpeed();
        
        // First check if the wandering behavior exists
        if (wanderingBehavior == null)
        {
        ...
        // EXACTLY match the enemy approach - completely delegate to AIWandering
        ...
        // This is key to prevent double-movements
        hasAppliedMovementThisFrame = true;
    }
