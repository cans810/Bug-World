...
public class BaseInteraction : MonoBehaviour
{
    ...
    private void DepositPlayerCrumbs()
    {
        ...
        if (currentCrumbs > 0)
        {
            ...
            // Only show visual effects if NOT depositing to equipped entity
            if (visualEffectManager != null && !hasEquippedEntity)
            {
            ...
            else if (hasEquippedEntity)
            {
                ...
                // Directly update the entity controller without animation delay
                entityController.UpdateEquippedEntityCrumbCount(currentCrumbs);
