...
public class ChitinDepositArrowManager : MonoBehaviour
{
    ...
    private ScreenCenterArrowIndicator arrowIndicator;
    ...
    private void Start()
    {
        ...
        // Add screen center arrow indicator component
        arrowIndicator = gameObject.AddComponent<ScreenCenterArrowIndicator>();
