...
public class CameraAnimations : MonoBehaviour
{
    ...
    private IEnumerator AnimateCameraToArea(Transform areaTarget, int level = 0, string areaName = "", bool isEgg = false)
    {
        ...
        float useHeightOffset = isEgg ? 3.5f : heightOffset;  // Higher for eggs to get better angle
        float useLookDownAngle = isEgg ? 60f : lookDownAngle; // Change from 90° (straight down) to 60° for eggs
