...
public class UIHelper : MonoBehaviour
{
    ...
    [SerializeField] private GameObject sizeUpText; // Reference to the Size Up text GameObject
    ...
    // Method to show size up text for 3 seconds
    public void ShowSizeUpText()
    {
        // Make sure we have a reference to the text object
        if (sizeUpText != null)
        {
            // Activate the size up text
        ...
        {
            Debug.LogWarning("UIHelper: sizeUpText reference is missing!");
        }
    }
