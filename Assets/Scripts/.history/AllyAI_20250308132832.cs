...
public class AllyAI : MonoBehaviour
{
    ...
    {
        // Don't target loot if we're already carrying something, in combat,
    ...
    {
        // If loot reference is lost, go back to previous mode
        ...
        // Check if enough time has passed for approach AND if close enough to pick up
        ...
        // Only pick up if both time and distance requirements are met
