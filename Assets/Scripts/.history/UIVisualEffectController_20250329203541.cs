...
public class UIVisualEffectController : MonoBehaviour
{
    ...
    private IEnumerator SpawnCoinSymbols(Vector2 spawnPosition, int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            // Set a smaller scale for the coins
            Vector3 coinScale = new Vector3(0.25f, 0.25f, 0.25f);
            symbolRT.localScale = coinScale;
            ...
            StartCoroutine(AnimateCoinToPanel(coinSymbol, panelCenter, coinScale));
