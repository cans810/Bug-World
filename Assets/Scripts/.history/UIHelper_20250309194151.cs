...
public class UIHelper : MonoBehaviour
{
    ...
    [Header("Inform Text")]
    [SerializeField] private GameObject informTextPanel;
    ...
    private void Awake()
    {
        ...
        if (informTextAnimator == null && informTextPanel != null)
        {
            informTextAnimator = informTextPanel.GetComponent<Animator>();
        }
    }
    ...
    {
        if (informText == null || informTextPanel == null || informTextAnimator == null)
        {
        ...
        informTextPanel.SetActive(true);
