...
public class BorderVisualizer : MonoBehaviour
{
    ...
    private void CreateVisualSphere()
    {
        ...
        {
            // Create a visualization of the collider
            if (sphereCollider != null)
            {
                // Create a sphere visualization - existing code
                // ...existing sphere visualization code...
            }
            else if (capsuleCollider != null)
            {
                // Create a capsule visualization
                visualSphere = GameObject.CreatePrimitive(PrimitiveType.Capsule);
                visualSphere.name = "BorderVisual_" + gameObject.name;
                
                // Remove the collider from the visual to prevent physics interactions
                ...
                // Set the visual as a child of this object
                ...
                // Set scale to match the collider's dimensions
                ...
                // Apply the material to the capsule
                Renderer renderer = visualSphere.GetComponent<Renderer>();
                renderer.material = instanceMaterial;
                
                // Disable shadow casting for the visual capsule
                renderer.shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
                renderer.receiveShadows = false;
            }
            // Handle box collider if needed...
        }
    }
