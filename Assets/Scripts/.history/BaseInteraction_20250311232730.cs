...
public class BaseInteraction : MonoBehaviour
{
    ...
    private void StartHealing()
    {
        ...
        if (playerEntity != null && playerOutline != null)
        {
            ...
            StartCoroutine(ForceOutlineUpdate(playerOutline));
        }
        ...
        foreach (var entity in alliesInBase)
        {
            if (entity != null && allyOutlines.ContainsKey(entity))
            {
                ...
                if (outline != null)
                {
                    ...
                    // Force an immediate update of the outline
                    StartCoroutine(ForceOutlineUpdate(outline));
                }
            }
        }
    ...
    // Add a coroutine to force outline update
    private IEnumerator ForceOutlineUpdate(EntityOutline outline)
    {
