...
public class LevelUpPanelHelper : MonoBehaviour
{
    ...
    public void OnGetChitinCapacityRewardButtonClicked()
    {
        ...
        // Force UI update for chitin capacity
        if (playerInventory != null)
        {
            // This will trigger the OnChitinCountChanged event to update UI
    ...
    public void OnGetCrumbCapacityRewardButtonClicked()
    {
        ...
        // Force UI update for crumb capacity
        if (playerInventory != null)
        {
            // This will trigger the OnCrumbCountChanged event to update UI
