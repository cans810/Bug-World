...
public class PlayerHealthBarController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        targetEntity.OnDamaged.AddListener(OnPlayerDamaged);
        targetEntity.OnHealed.AddListener(OnPlayerHealed);
    ...
    private void OnDestroy()
    {
        ...
        if (targetEntity != null)
        {
            targetEntity.OnDamaged.RemoveListener(OnPlayerDamaged);
            targetEntity.OnHealed.RemoveListener(OnPlayerHealed);
