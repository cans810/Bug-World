...
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] private string[] touchableUILayers = new string[] { "TouchableUI", "PlayerNest1","PlayerNest2","PlayerNest3"rNest8","PlayerNest9","PlayerNest10" }; // UI elements on these layers can be touched through
