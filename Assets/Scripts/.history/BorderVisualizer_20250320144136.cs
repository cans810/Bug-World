...
public class BorderVisualizer : MonoBehaviour
{
    ...
    public void FadeOutAndDisable()
    {
        ...
        if (!isFading && !hasBeenDisabled && visualSphere != null)
        {
    ...
    private IEnumerator FadeOutVisualization()
    {
        ...
        // Get the renderers to fade out
        Renderer[] renderers = visualSphere.GetComponentsInChildren<Renderer>();
        if (renderers.Length == 0)
        {
            // No renderers found, just disable
