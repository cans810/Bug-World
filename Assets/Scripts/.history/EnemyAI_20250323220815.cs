...
public class EnemyAI : MonoBehaviour
{
    ...
    // Modify FaceTarget to maintain smooth turning even in combat stance
    private void FaceTarget(Vector3 target)
    {
        ...
        if (directionToTarget.magnitude > 0.1f)
        {
            ...
            // For both combat and non-combat, use smooth rotation
            // Use a faster rotation speed when in combat stance
            float rotationSpeed = inCombatStance ? targetRotationSpeed * 1.5f : targetRotationSpeed;
    ...
    public IEnumerator FacePlayerWhileInHitbox(LivingEntity playerEntity)
    {
        while (isPlayerInHitbox && !livingEntity.IsDead && playerEntity != null && !playerEntity.IsDead)
        {
            ...
            {
                // Use smooth rotation with Slerp instead of direct assignment
