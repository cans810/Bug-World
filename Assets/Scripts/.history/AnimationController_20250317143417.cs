...
public class AnimationController : MonoBehaviour
{
    ...
    private void UpdateAnimatorParameters()
    {
        ...
        {
            // When walk attacking, only set walkAttack parameter
            animator.SetBool(walkAttackParam, true);
            animator.SetFloat(walkSpeedParam, 1f); // Keep walk speed
    ...
    public void SetWalking(bool walking)
    {
        ...
        {
            // If we're attacking and start walking, switch to walk attack
            if (isAttacking && walking)
            {
    ...
    public void SetAttacking(bool attacking)
    {
        ...
        // If we're walking and attacking, set walk attack state (Player only)
        if (attacking && isWalking && gameObject.CompareTag("Player"))
        {
            isWalkAttacking = true;
            isAttacking = false;
        }
