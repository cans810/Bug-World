...
public class AlliesPanelDisplay : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (alliesPanel != null && (playerAttributes == null || playerAttributes.AllyPoints <= 0))
        {
    ...
    private void ShowPanel()
    {
        if (uiHelper != null)
        {
            uiHelper.ShowAlliesPanel();
        }
        else if (alliesPanel != null)
        {
    ...
    private void UpdateDisplay()
    {
        if (playerAttributes != null)
        {
            ...
            if (antPointsText != null)
                antPointsText.text = $"Ally Points: {playerAttributes.AllyPoints}";
        }
    }
