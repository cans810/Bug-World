...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Subscribe to our own OnChitinMaxed event to show the arrow
        OnChitinMaxed += ShowNestArrowWhenFull;
    }
            ...
            if (uiHelper != null && uiHelper.ItemInformPanel != null)
            {
                ...
                if (itemInfo != null)
                {
                    ...
                    if (arrowManager != null)
                    {
                        ...
                        if (uiHelper != null)
                        {
                            uiHelper.ShowPersistentInformText("Go to your nest to deposit your chitin.");
                        }
                    }
                }
            }
    ...
    // Add this method to handle full chitin capacity
    private void ShowNestArrowWhenFull()
    {
        Debug.Log("Chitin capacity reached - showing arrow to nest");
        ...
        if (arrowManager != null)
        {
            ...
            // Show normal inform text in red about depositing (with 6 second duration)
            UIHelper uiHelper = FindObjectOfType<UIHelper>();
            if (uiHelper != null)
            {
                // Use regular ShowInformText with 6-second duration instead of persistent text
                uiHelper.ShowInformText("<color=red>Chitin Capacity Reached! Go To Your Nest To Deposit.</color>", 6f);
            }
        }
        else
        {
            Debug.LogWarning("ChitinDepositArrowManager not found! Cannot show arrow to nest.");
        }
    }
} 