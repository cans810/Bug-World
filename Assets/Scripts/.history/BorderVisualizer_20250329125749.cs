...
public class BorderVisualizer : MonoBehaviour
{
    ...
    private void DrawCapsulePerimeter()
    {
        ...
        // For X or Z axis capsules, we create a stadium shape (rectangle with semicircles at ends)
        float halfLength = (height - 2f * radius) * 0.5f;
        
        // We'll divide our points into 4 sections:
        // 1. Right semicircle (1/4 of total points)
        // 2. Bottom straight line (1/4 of total points)
        // 3. Left semicircle (1/4 of total points)
        // 4. Top straight line (1/4 of total points)
        
        int pointsPerSection = segments / 4;
        int index = 0;
        
        // Section 1: Right semicircle
        for (int i = 0; i <= pointsPerSection; i++)
        {
            float t = (float)i / pointsPerSection;
            float angle = Mathf.PI * 0.5f - t * Mathf.PI;
        ...
        // Section 2: Bottom straight line
        for (int i = 0; i <= pointsPerSection; i++)
        {
            float t = (float)i / pointsPerSection;
            ...
            if (direction == 0) // X-axis
            {
                x = center.x + halfLength - t * 2f * halfLength;
                z = center.z - radius;
            }
            else // Z-axis
            {
                x = center.x - radius;
                z = center.z + halfLength - t * 2f * halfLength;
            }
        ...
        // Section 3: Left semicircle
        for (int i = 0; i <= pointsPerSection; i++)
        {
            float t = (float)i / pointsPerSection;
            float angle = Mathf.PI * 1.5f - t * Mathf.PI;
        ...
        // Section 4: Top straight line (connect back to start)
        for (int i = 0; i < pointsPerSection; i++)
        {
            float t = (float)i / pointsPerSection;
