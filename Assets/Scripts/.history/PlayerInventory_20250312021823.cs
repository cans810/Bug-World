...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            // If inventory is full and this is carried loot, don't even try to collect
            if (other.gameObject.layer == carriedLootLayerNumber && IsChitinFull)
            {
                ...
                if (showDebugMessages)
                {
                    Debug.Log($"Cannot collect carried loot: inventory full ({ChitinCount}/{maxChitinCapacity})");
                }
    ...
    public void DepositChitinAtBase(int amount)
    {
        ...
        // Remove chitin from inventory first
        ChitinCount -= amount;
        ...
        if (uiHelper != null)
        {
            ...
            uiHelper.DebugAnimateChitins(amountToAnimate);
        }
        else
        {
        ...
        Debug.Log($"[CRITICAL] Deposit completed. Animated {amountToAnimate} chitins.");
    }
