...
public class EnemyAI : MonoBehaviour
{
    ...
    // Implement smooth sliding rotation with consistent turning speed
    private void FaceTarget(Vector3 target)
    {
        ...
        if (directionToTarget.magnitude > 0.1f)
        {
            ...
            // Use a consistent, moderate rotation speed for a sliding effect
            float rotationSpeed = inCombatStance ? 1.5f : 1.0f;
            
            // Apply smooth rotation using Slerp with consistent speed
            // The key is using a low, fixed value that creates a sliding feel
    ...
    // Updated coroutine for smooth sliding rotation while player is in hitbox
    ...
    // Modified method to handle player entering hitbox with smooth rotation
    protected virtual void HandlePlayerEnterHitbox(LivingEntity playerEntity)
    {
        ...
        // Start the rotation coroutine to face the player with smooth turning
