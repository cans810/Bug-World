...
public class UIHelper : MonoBehaviour
{
    ...
    // Add a method to show attributes panel that marks it as player-initiated
    public void ShowAttributesPanel()
    {
        ...
        if (attributeDisplay != null)
        {
            // Call a dedicated method that indicates this is a player action
            attributeDisplay.ShowPanelFromPlayerAction(true);
        }
        else
        {
            Debug.LogError("UIHelper: Cannot show attributes panel - AttributeDisplay not found");
        }
    }
    ...
    // Add this to UIHelper - an emergency method to show the panel directly
    public void EmergencyShowAttributesPanel()
    {
        Debug.Log("UIHelper: EmergencyShowAttributesPanel called!");
        
        // Find the attributes panel by name in case it's not properly linked
        GameObject attributesPanel = GameObject.Find("AttributesPanel");
        if (attributesPanel != null)
        {
            attributesPanel.SetActive(true);
            Debug.Log("UIHelper: Direct activation of attributes panel by name");
        ...
        {
            Debug.LogError("UIHelper: Could not find AttributesPanel by name!");
        }
    }
} 
