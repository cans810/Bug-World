...
public class PlayerInventory : MonoBehaviour
{
    ...
    // In the DepositChitin method, add this after adding XP
    public void DepositChitin(int amount)
    {
        if (ChitinCount < amount)
        {
            Debug.LogWarning("Not enough chitin to deposit");
            return;
        }
        ...
        Debug.Log($"XP SYSTEM: Deposited {amount} chitin for {xpGain} XP");
    }
    ...
    // Find where player data is saved, likely in a Save() or similar method
    public void Save(GameSaveData saveData) // or similar signature
    {
        // existing saving code...
        
        // Add these lines to save egg data
        saveData.currentEggCount = currentEggCount; // or whatever variable stores current eggs
        saveData.maxEggCapacity = maxEggCapacity; // or whatever variable stores max capacity
        
        // existing code...
    }

    // Find where player data is loaded, likely in a Load() or similar method
    public void Load(GameSaveData saveData) // or similar signature
    {
        // existing loading code...
        
        // Add these lines to load egg data
        currentEggCount = saveData.currentEggCount; // or whatever variable stores current eggs
        maxEggCapacity = saveData.maxEggCapacity; // or whatever variable stores max capacity
