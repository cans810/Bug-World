...
public class GameManager : MonoBehaviour
{
    ...
    {
        // Define the levels at which new areas unlock
        // You can customize this list based on your game design
        switch (level)
        {
            case 2:  // Forest area unlocks at level 2
                return true;
            case 4:  // Cave area unlocks at level 4
                return true;
            case 6:  // Garden area unlocks at level 6
                return true;
            case 8:  // Final area unlocks at level 8
                return true;
            default:
                return false;
        }
