...
public class GameManager : MonoBehaviour
{
    ...
    private bool IsEdgeVertex(int index, Mesh mesh)
    {
        ...
        return Mathf.Abs(currentVertex.x - minX) < tolerance || Mathf.Abs(currentVertex.x - maxX) < tolerance ||
               Mathf.Abs(currentVertex.z - minZ) < tolerance || Mathf.Abs(currentVertex.z - maxZ) < tolerance;
    }
}
