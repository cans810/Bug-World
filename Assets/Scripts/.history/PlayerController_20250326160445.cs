...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator SetupPlayerAndCameraBasedOnLevel()
    {
        ...
        if (playerInventory != null)
        {
            ...
            // Subscribe to level up events if not already done
            bool alreadySubscribed = false;
            foreach (var d in playerInventory.OnLevelUp.GetInvocationList())
            {
                if (d.Target == this && d.Method.Name == "OnPlayerLevelUp")
                {
