...
public class UIHelper : MonoBehaviour
{
    ...
    public void ShowMapPanel()
    {
        ...
        mapPanel.transform..GetComponent<Animator>().SetBool("ShowUp", true);
        mapPanel.transform.GetComponent<Animator>().SetBool("Hide", false);
    }

    public void HideMapPanel()  
    {
        mapPanel.GetComponent<Animator>().SetBool("ShowUp", false);
        mapPanel.GetComponent<Animator>().SetBool("Hide", true);
    }
