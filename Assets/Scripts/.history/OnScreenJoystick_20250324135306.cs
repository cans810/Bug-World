...
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] private string[] touchableUILayers = new string[] { "TouchableUI", "PlayerNest1","PlayerNest2","PlayerNest3"}; // UI elements on these layers can be touched through
    ...
    // Add this method to reset the joystick state
    public void ResetJoystick()
    {
        ...
        // Make sure joystick is visible if using fixed position
        SetJoystickVisibility(useFixedPosition);
    }
} 