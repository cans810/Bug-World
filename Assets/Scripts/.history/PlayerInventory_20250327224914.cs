...
public class PlayerInventory : MonoBehaviour
{
    ...
    public bool AddCrumb(int amount = 1, bool playSound = true)
    {
        ...
        if (hasYetToCollectCrumb && amount > 0)
        {
            ...
            Debug.Log("Player collected crumb for the first time!");
            
            // You might want to trigger a tutorial or show a message
            UIHelper uiHelper = FindObjectOfType<UIHelper>();
            if (uiHelper != null)
            {
                uiHelper.ShowInformText("You collected your first Crumb!");
            }
        }
        ...
        // Play pickup sound
        if (playSound && audioSource != null && collectionSound != null)
        {
            audioSource.PlayOneShot(collectionSound);
        }
    ...
    public bool AddChitin(int amount = 1, bool playSound = true)
    {
        ...
        if (hasYetToCollectChitin && amount > 0)
        {
            ...
            Debug.Log("Player collected chitin for the first time!");
            ...
            if (arrowManager != null)
            {
                ...
                Debug.Log("Showing arrow to the nest for first chitin collection");
            }
            else
            {
