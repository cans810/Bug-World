...
public class AllyAntPanelController : MonoBehaviour
{
    ...
    {
        // Re-enable all ally ant buttons when the panel is closed
        GameObject[] allyAntButtons = GameObject.FindGameObjectsWithTag("AllyAntButton");
        foreach (GameObject button in allyAntButtons)
        {
