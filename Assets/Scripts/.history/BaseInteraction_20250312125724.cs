...
public class BaseInteraction : MonoBehaviour
{
    ...
    [SerializeField] private HealingEffectManager healingEffectManager;
    ...
    private void Awake()
    {
        ...
        // Find healing effect manager if not assigned
        if (healingEffectManager == null)
        {
            healingEffectManager = FindObjectOfType<HealingEffectManager>();
        }
    }
