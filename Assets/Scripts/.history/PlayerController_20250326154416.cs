...
public class PlayerController : MonoBehaviour
{
    ...
    private void UpdateCameraSettings(int level)
    {
        ...
        if (level >= 52)
        {
            cameraController.SetCameraParameters(6.66f, 8.96f);
        }
        else if (level >= 47)
        {
            cameraController.SetCameraParameters(5.4f, 7.81f);
        }
        else if (level >= 42)
        {
            cameraController.SetCameraParameters(4.86f, 6.83f);
        }
        else if (level >= 37)
        {
            cameraController.SetCameraParameters(4.32f, 6.15f);
        }
        else if (level >= 32)
        {
            cameraController.SetCameraParameters(3.98f, 5.42f);
        }
        else if (level >= 27)
        {
            cameraController.SetCameraParameters(3.43f, 4.59f);
        }
        else if (level >= 22)
        {
            cameraController.SetCameraParameters(2.73f, 3.78f);
        }
        else if (level >= 17)
        {
            cameraController.SetCameraParameters(2.83f, 3.88f);
        }
        else if (level >= 12)
        {
            cameraController.SetCameraParameters(2.25f, 3.03f);
        }
        else if (level >= 7)
        {
            cameraController.SetCameraParameters(1.86f, 2.55f);
        }
        else if (level >= 2)
        {
            cameraController.SetCameraParameters(1.74f, 2.32f);
        }
        else
        {
            // Default settings for levels 1-4
            cameraController.SetCameraParameters(1.3f, 1.8f);
        }
    }
