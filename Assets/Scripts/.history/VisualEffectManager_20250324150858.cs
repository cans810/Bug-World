...
public class VisualEffectManager : MonoBehaviour
{
    ...
    public void PlayAttackEffect(Vector3 position)
    {
        ...
        // If there's a cooldown message, use the correct text component
        if (uiHelper != null && attackCooldown > 0)
        {
            uiHelper.ShowAttackCooldownText($"Cooldown: {attackCooldown:F1}s");
        }
