...
public class LivingEntity : MonoBehaviour
{
    ...
    public void RotateTowards(Vector3 targetDirection, float speedMultiplier = 1.0f)
    {
        ...
        // Calculate rotation with frame-independent speed
        float actualRotationSpeed = rotationSpeed * speedMultiplier;
        float step = actualRotationSpeed * Time.deltaTime;
