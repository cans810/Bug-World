...
public class MapBoundary : MonoBehaviour
{
    ...
    {
        // Get boundary center (this GameObject's position)
        Vector3 center = transform.position;
        
        // Calculate half-sizes
        Vector3 halfSize = new Vector3(mapSize.x, wallHeight, mapSize.y) * 0.5f;
        
        // Check if point is outside on any axis
    ...
    private void OnDrawGizmos()
    {
        ...
        // Draw a wireframe cube representing the boundary
        Gizmos.DrawWireCube(transform.position, new Vector3(mapSize.x, wallHeight, mapSize.y));
        
        // Draw a semi-transparent cube
        Gizmos.color = new Color(boundaryColor.r, boundaryColor.g, boundaryColor.b, 0.2f);
        Gizmos.DrawCube(transform.position, new Vector3(mapSize.x, wallHeight, mapSize.y));
    }
} 