...
public class GameManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        // Save nest first visit state
        BaseInteraction baseInteraction = FindObjectOfType<BaseInteraction>();
        if (baseInteraction != null)
        {
            baseInteraction.SaveFirstVisitState(gameData);
        }
        
        // Save first crumb deposit state
        if (baseInteraction != null)
        {
            baseInteraction.SaveFirstCrumbDepositState(gameData);
        }
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        // Load nest first visit state
        BaseInteraction baseInteraction = FindObjectOfType<BaseInteraction>();
        if (baseInteraction != null)
        {
            baseInteraction.LoadFirstVisitState(gameData);
        }

        // Load first crumb deposit state
        if (baseInteraction != null)
        {
            baseInteraction.LoadFirstCrumbDepositState(gameData);
        }
    }
