...
public class LivingEntity : MonoBehaviour
{
    ...
    [SerializeField] private float sinkingDuration = 2.0f;  // How long it takes to sink fully
    [SerializeField] private float sinkingDepth = 1.5f;     // How far down to sink
    [SerializeField] private AnimationCurve sinkingCurve = AnimationCurve.EaseInOut(0f, 0f, 1f, 1f);  // Default ease in-out curve
