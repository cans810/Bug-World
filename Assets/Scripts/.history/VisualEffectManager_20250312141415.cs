...
public class VisualEffectManager : MonoBehaviour
{
    ...
    private void InitializePool(string type, GameObject prefab)
    {
        ...
        for (int i = 0; i < poolSizePerType; i++)
        {
            ...
            // Set all symbols to base scale (0.03)
    ...
    private IEnumerator AnimateResourceCollection(GameObject symbol, string type)
    {
        ...
        Vector3 initialScale = type switch
        {
            "chitin" => baseScale * 2.67f, // 0.03 * 2.67 ≈ 0.08
            "crumb" => baseScale * 33.33f, // 0.03 * 33.33 ≈ 1
            _ => baseScale
        };
        ...
        while (elapsed < chitinFlyDuration)
        {
            ...
            symbol.transform.localScale = initialScale * pulseScale;
        ...
        symbol.transform.localScale = baseScale; // Reset to base scale when returning to pool
        symbol.SetActive(false);
