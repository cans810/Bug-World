...
public class AllyAI : MonoBehaviour
{
    ...
    private void FollowPlayerBehavior()
    {
        ...
        // Note: completely drop our custom player movement detection and use the simple distance approach
        ...
        else
        {
            ...
            // Face and move towards player - EXACTLY like enemy chasing
            FaceTarget(playerTransform.position);
            
            // Use the SAME movement method as the enemy AI - direct use of LivingEntity
