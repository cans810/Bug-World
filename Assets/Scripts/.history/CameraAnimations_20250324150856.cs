...
public class CameraAnimations : MonoBehaviour
{
    ...
    // Check for any attack-related messages during camera animations
    private IEnumerator PlayCameraAnimation()
    {
        // ... other code ...

        // If showing attack cooldown, use the correct text component
        if (uiHelper != null && isAttackCooldown)
        {
            uiHelper.ShowAttackCooldownText($"Cooldown: {cooldownTime:F1}s");
        }
