...
public class LivingEntity : MonoBehaviour
{
    ...
    // Add this method to LivingEntity.cs
    // This will be called by animation events during attack animations
    public void DealDamage()
    {
        if (isDead || targetsInRange.Count == 0)
            return;
    ...
    // Add this method to get the best target from those in range
    private LivingEntity GetBestTarget()
    {
        ...
        if (currentTarget != null && !currentTarget.IsDead && targetsInRange.Contains(currentTarget))
            return currentTarget;
        
        // Clean up dead targets from list
