...
public class PlayerController : MonoBehaviour
{
    ...
    private IEnumerator ReviveAfterDelay(float delay)
    {
        ...
        // Clear all targets to prevent auto-attacking after teleport
        EntityHitbox hitbox = GetComponentInChildren<EntityHitbox>();
        if (hitbox != null)
        {
            hitbox.ClearAllTargets();
        }
        
        // Also directly stop any attack animations or states
        StopAllAttacks();
    }
    ...
    private void OnPlayerLevelUp(int newLevel)
    {
        ...
        {
            visualEffectManager.PlayLevelUpEffect(transform.position);
        }
        else
        {
            Debug.LogWarning("VisualEffectManager not found for level up animation");
        }
    }
