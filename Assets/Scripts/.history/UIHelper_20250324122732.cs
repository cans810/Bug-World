...
public class UIHelper : MonoBehaviour
{
    ...
    private void UpdateCooldownTextPosition()
    {
        ...
        // Get position at bottom of player (using negative Y offset)
        Vector3 playerPos = player.transform.position + new Vector3(0, -0.5f, 0);
        ...
        if (textRect != null)
        {
            // Apply offset (reduced Y offset for closer placement)
