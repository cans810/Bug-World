...
public class LivingEntity : MonoBehaviour
{
    ...
    public virtual void TakeDamage(float damageAmount, object damageSource = null)
    {
        // Check if entity is invulnerable or already dead
    ...
    public virtual void Die(object killer = null)
    {
