...
public class GameManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        {
            gameData.currentHP = playerEntity.CurrentHealth;
            gameData.currentMaxHP = playerEntity.MaxHealth;
        }
    ...
    public void LoadGameAndUpdateUI()
    {
        ...
        Debug.Log("Game data loaded and UI updated.");
    }
}
