...
public class PlayerInventory : MonoBehaviour
{
    ...
    [SerializeField] private int maxChitinCapacity = 100;
    ...
    public event Action OnChitinMaxed; // New event for when player tries to collect at max capacity
    ...
    {
        // Don't allow adding more if we're at capacity
