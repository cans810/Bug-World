...
public class SavedMissionData
{
    ...
    public SavedMissionData(string id, bool isActive, bool isCompleted, int currentAmount)
    {
        this.id = id;
...
public class GameData
{
    ...
    public bool isNest2Purchased = false;
    public bool isNest3Purchased = false;

    public bool isRockBarriersRemoved = false;

    // Mission data
    public List<SavedMissionData> missionProgress = new List<SavedMissionData>();

    // Add this to the GameData class properties
    public List<string> unlockedBorderAreas = new List<string>();

    // Add this field to the GameData class
    public bool hasEnteredNestForFirstTime = false;

    // Add this field to the GameData class
    public bool hasEnteredWithCrumbsForFirstTime = false;
    ...
    public GameData()
    {
        ...
        this.maxChitinCapacity = 30;
        this.maxCrumbCapacity = 2;
        ...
        this.isNest2Purchased = false;
        this.isNest3Purchased = false;

        this.isRockBarriersRemoved = false;

        // Initialize mission progress list
        missionProgress = new List<SavedMissionData>();

        // Initialize the border areas list
        unlockedBorderAreas = new List<string>();

        this.hasEnteredNestForFirstTime = false;
        this.hasEnteredWithCrumbsForFirstTime = false;
    }
}
