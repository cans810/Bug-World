...
public class GameData
{
    ...
    public GameData()
    {
        ...
        purchasedEntities.Add("ant"); // Assuming ant is purchased by default

        // Initialize the active eggs list
        activeEggs = new List<EggData>();
    }
}

// Add this serializable class to store egg data
[System.Serializable]
public class EggData
{
    public string entityType = "ant";
    ...
    // Constructor to easily create from an existing egg
    public EggData(string entityType, float remainingTime, Vector3 position, Quaternion rotation)
    {
