...
public class GameData
{
    ...
    public void CaptureGameState(/* parameters you need to capture state */)
    {
        // Add code to capture the current game state
        // For example:
        // this.score = GameManager.Instance.Score;
        // this.playerPosition = Player.Instance.transform.position;
        // etc.
    }
}
