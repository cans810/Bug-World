...
public class GameData
{
    ...
    // Add entity purchase status
    public Dictionary<string, bool> entityPurchaseStatus = new Dictionary<string, bool>();
    ...
    public GameData()
    {
        ...
        this.currentCoin = 0;
        this.entityPurchaseStatus = new Dictionary<string, bool>();
        this.equippedEntity = "";
    }
}
