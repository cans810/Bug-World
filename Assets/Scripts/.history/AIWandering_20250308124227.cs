...
public class AIWandering : MonoBehaviour
{
    ...
    {
        float randomDistance = Random.Range(minWanderDistance, maxWanderDistance); // * gets a random distance between min and max wander distance
        float randomAngle = Random.Range(0f, 360f) * Mathf.Deg2Rad; // * gets a random angle between 0 and 360 degrees
    ...
    {
        // Return true if the AI is currently moving to a wander point
        // This implementation may vary based on your AIWandering implementation
        return isWandering;
    }
}