...
public class PlayerInventory : MonoBehaviour
{
    ...
    {
        // Log the level-up
        Debug.Log($"PlayerInventory: Level up! Player is now level {newLevel}");
        ...
        if (cameraAnimations != null)
        {
            ...
            if (newAreaUnlocked)
            {
                ...
                Debug.Log($"PlayerInventory: New area unlocked at level {newLevel}, showing camera animation");
            ...
            else
            {
                ...
                Debug.Log($"PlayerInventory: No new area at level {newLevel}, showing attributes panel directly");
        ...
        {
            Debug.LogError("PlayerInventory: CameraAnimations component not found");
            
            // Fallback if there's no camera animations component
            Debug.Log("PlayerInventory: No CameraAnimations component found, showing attributes panel directly");
            AttributeDisplay attributeDisplay = FindObjectOfType<AttributeDisplay>();
            if (attributeDisplay != null)
            {
                attributeDisplay.ShowPanel(true);
