...
public class VisualEffectManager : MonoBehaviour
{
    ...
    // Update to initialize pools as UI elements in Canvas
    private void InitializeUIPool(string poolName, GameObject prefab, int count = 10)
    {
        if (prefab == null) return;
    ...
    // Fix sizing in InitializeUIPool method
    private void InitializeUIPool(string type, GameObject prefab, int count = 10)
    {
        // Previous code...
