...
public class BaseInteraction : MonoBehaviour
{
    ...
    private void DepositPlayerChitin()
    {
        ...
        if (currentChitin > 0)
        {
            ...
            // Call method that explicitly gives the correct XP
            playerInventory.DepositChitin(currentChitin);
            
            // Don't call DepositAllChitinAtBase() as it might double-count XP
            // The DepositChitin method will handle both XP gain and removing chitin
