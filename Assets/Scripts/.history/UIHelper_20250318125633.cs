...
public class UIHelper : MonoBehaviour
{
    ...
    private void OnPlayerLevelUp(int newLevel)
    {
        ...
        // Always show the attributes panel on level up
        ...
        // Remove the camera animation check and shouldShowAttributesPanel flag
        // since we're always showing the panel directly
    }
