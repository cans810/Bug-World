...
public class UIHelper : MonoBehaviour
{
    ...
    public void OnAllyAntsPanelClosed()
    {
        ...
        allyAntsPanel.SetActive(false);
    }

    public void OnAllAllyAntsOrderPanelClicked()
    {
        allyAntsOrdersPanel.SetActive(true);
        allyAntsOrdersPanel.GetComponent<Animator>().SetBool("ShowUp", true);
        allyAntsOrdersPanel.GetComponent<Animator>().SetBool("Hide", false);
    }

    public void OnAllAllyAntsOrderPanelClosed()
    {
        allyAntsOrdersPanel.GetComponent<Animator>().SetBool("ShowUp", false);
        allyAntsOrdersPanel.GetComponent<Animator>().SetBool("Hide", true);
        allyAntsOrdersPanel.SetActive(false);
    }
