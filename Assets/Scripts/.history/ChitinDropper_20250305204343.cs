...
public class ChitinDropper : MonoBehaviour
{
    ...
    [SerializeField] private float scatterRadius = 1.0f; // How far to scatter multiple chitin pieces
    [SerializeField] private float maxDropForce = 3.0f; // Maximum force to apply to dropped chitin
