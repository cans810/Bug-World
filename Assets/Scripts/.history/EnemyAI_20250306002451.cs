...
public class EnemyAI : MonoBehaviour
{
    ...
    private void ChaseAndAttackTarget()
    {
        ...
        {
            // Stop moving - only update animation if state is changing
            if (isMoving)
            {
                isMoving = false;
                UpdateAnimation(false); // This will set the walking animation to false
            }
        ...
        else
        {
            ...
            {
                isMoving = true;
                UpdateAnimation(true); // This will set the walking animation to true
            }
