...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        // Check if player health is critically low
        if (livingEntity != null && livingEntity.CurrentHealth < 1f && !animController.IsAnimationPlaying("death"))
        {
            // Force death if health drops below 1
            livingEntity.Die();
            return;
        }
