...
public class VisualEffectManager : MonoBehaviour
{
    ...
    private IEnumerator AnimateXPSymbolToScreen(GameObject symbol, Vector2 targetScreenPos)
    {
        ...
        // IMPORTANT: Play sound BEFORE returning the symbol to the pool
        // This ensures the sound plays at the exact moment the symbol reaches its destination
        PlayXPSound();
