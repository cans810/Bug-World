...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        // Don't process input if player can't move
        if (!canMove)
        {
            // Make sure the joystick is reset
    ...
    // Add this method to enable/disable movement
    public void SetCanMove(bool canMove)
    {
        this.canMove = canMove;
        
        // Stop momentum when disabling movement
        if (!canMove)
        {
