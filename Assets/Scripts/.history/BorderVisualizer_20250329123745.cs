...
public class BorderVisualizer : MonoBehaviour
{
    ...
    private void DrawCapsulePerimeter()
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            // Project to the perimeter height
            if (capsuleCollider.direction == 1) // Y axis
            {
                position.y = perimeterHeight;
            }
            else if (capsuleCollider.direction == 0) // X axis
            {
                position.x = perimeterHeight;
            }
            else if (capsuleCollider.direction == 2) // Z axis
            {
                position.z = perimeterHeight;
            }
