...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void ForceUpdateUI()
    {
        ...
        // If we're loading data, just update the level display without the animation
        else if (OnLevelDisplayUpdate != null)
            OnLevelDisplayUpdate(CurrentLevel); // You might need to add this event
    }
