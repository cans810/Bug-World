...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Check initial level and apply appropriate scale
        if (enableMetamorphosis)
        {
            if (playerInventory != null)
            {
                Debug.Log($"Applying initial metamorphosis scale for level {playerInventory.CurrentLevel}");
                ApplyMetamorphosisScale(playerInventory.CurrentLevel);
            }
            else
            {
                Debug.LogError("playerInventory is null. Can't apply initial metamorphosis scale.");
            }
        }
