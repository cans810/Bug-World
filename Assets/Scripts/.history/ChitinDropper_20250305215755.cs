...
public class ChitinDropper : MonoBehaviour
{
    ...
    [SerializeField] private float upwardForceMin = 80f; // Dramatically increased upward force
    [SerializeField] private float upwardForceMax = 120f; // Higher upper bound
