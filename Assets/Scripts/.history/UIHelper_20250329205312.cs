...
public class UIHelper : MonoBehaviour
{
    ...
    public void UpdateAllResourceDisplays()
    {
        ...
        UpdateChitinDisplay(playerInventory.ChitinCount, playerInventory.MaxChitinCapacity);
        UpdateCrumbDisplay(playerInventory.CrumbCount, playerInventory.MaxCrumbCapacity);
        UpdateEggDisplay(playerInventory.EggCount, playerInventory.MaxEggCapacity);
        UpdateCoinDisplay(playerInventory.CoinCount);
        UpdateExperienceDisplay(playerInventory.TotalExperience, false);
