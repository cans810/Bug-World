...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("MapBorder"))
        {
            ...
            // For MapBorder2-5, PREVENT ENTRY (this is the original code for other prevention logic)
            if (borderName.StartsWith("MapBorder") && 
               (borderName == "MapBorder2" || 
                borderName == "MapBorder3" || 
                borderName == "MapBorder4" || 
                borderName == "MapBorder5"))
            {
                // Player has sufficient level but some other restriction applies
                // We maintain this code for other types of restrictions
