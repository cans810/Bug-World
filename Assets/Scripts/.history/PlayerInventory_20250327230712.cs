...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void ShowNestArrowWhenFull()
    {
        ...
        if (arrowManager != null)
        {
            ...
            // Show persistent inform text in red about depositing
            UIHelper uiHelper = FindObjectOfType<UIHelper>();
            if (uiHelper != null)
            {
                uiHelper.ShowPersistentInformText("<color=red>Chitin Capacity Reached! Go To Your Nest To Deposit.</color>");
            }
        }
        else
        {
