...
public class UIHelper : MonoBehaviour
{
    ...
    public void CloseRevivalAndLooseChitinAndCrumbsClicked()
    {
        ...
        if (playerInventory != null)
        {
            ...
            // Force update UI
            if (playerInventory.ForceUpdateUI != null)
            {
                playerInventory.ForceUpdateUI();
            }
            else
            {
                // Fallback if ForceUpdateUI doesn't exist
                if (playerInventory.OnChitinCountChanged != null)
                    playerInventory.OnChitinCountChanged.Invoke(playerInventory.ChitinCount);
                if (playerInventory.OnCrumbCountChanged != null)
                    playerInventory.OnCrumbCountChanged.Invoke(playerInventory.CrumbCount);
            }
