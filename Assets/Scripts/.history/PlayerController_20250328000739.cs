...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("MapBorder"))
        {
            ...
            // Always update the border name regardless of which border it is
            // Add this line to consistently track which border the player is in
            ...
            if (playerAttributes != null)
            {
                ...
                if (showDebugMessages)
                {
                    Debug.Log($"<color=green>Updated player's border object name to: {borderName}</color>");
                }
            }
