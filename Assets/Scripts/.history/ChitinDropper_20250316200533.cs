...
public class ChitinDropper : MonoBehaviour
{
    ...
    private IEnumerator SimpleChitinAnimation(GameObject chitinObject)
    {
        ...
        // Calculate a random landing position with medium spread (adjusted radius)
        float angle = Random.Range(0, 360) * Mathf.Deg2Rad;
        float spreadRadius = Random.Range(0.2f, 0.6f); // Increased from 0.1f-0.4f for slightly more spread
