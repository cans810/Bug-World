...
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] private string[] touchableUILayers = new string[] { "TouchableUI", "PlayerNest1","PlayerNest2","PlayerNest3"yerNest10" }; // UI elements on these layers can be touched through
