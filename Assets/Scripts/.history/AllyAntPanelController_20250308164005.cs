...
public class AllyAntPanelController : MonoBehaviour
{
    ...
    private Button currentlySelectedButton = null; // New field to track the selected button
    ...
    void Update()
    {
        ...
        // Update info for selected ant
        if (currentlySelectedAnt != null && antOrdersPanel != null && antOrdersPanel.activeSelf)
        {
            // Check if the selected ant still exists
    ...
    public void CloseOrdersPanel()
    {
        ...
        // Re-enable the currently selected button when closing the panel
        if (currentlySelectedButton != null)
        {
            currentlySelectedButton.interactable = true;
            currentlySelectedButton = null;
    ...
    private void OnDisable()
    {
        ...
        // Re-enable any selected button when the controller is disabled
        if (currentlySelectedButton != null)
        {
            currentlySelectedButton.interactable = true;
            currentlySelectedButton = null;
        ...
        // Clear the selected ant reference
        currentlySelectedAnt = null;
    }
}
