...
public class UIHelper : MonoBehaviour
{
    ...
    {
        Debug.Log("ShowPanel called - activating attributes panel");
        ...
        if (attributesPanel != null)
        {
            ...
            // Ensure the panel is properly focused
            if (EventSystem.current != null)
            {
                EventSystem.current.SetSelectedGameObject(attributesPanel);
            }
        }
        else
        {
            Debug.LogError("Attributes panel reference is null!");
        }
    }
