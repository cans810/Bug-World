...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void CheckAndTriggerLevelUp()
    {
        ...
        if (newLevel > CurrentLevel)
        {
            ...
            // Use the property setter or a private field instead
            ...
            if (playerAttributes != null)
            {
                // Use the proper method to add points based on what exists in PlayerAttributes
                // If the method is called differently, change this line
                if (playerAttributes.availablePoints != null)
                {
                    playerAttributes.availablePoints += playerAttributes.pointsPerLevel;
                    
                    // Notify UI that attributes changed
                    if (playerAttributes.OnAttributesChanged != null)
                    {
                        playerAttributes.OnAttributesChanged();
                    }
                }
            }
