...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void ProcessLevelUp(int level)
    {
        ...
        {
            // Add points BEFORE triggering any other level up effects
            ...
            Debug.Log($"<color=yellow>Level {level}: Added {pointsToAdd} attribute points</color>");
        }
        ...
        // Trigger events AFTER points are added
