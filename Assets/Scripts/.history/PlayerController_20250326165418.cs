...
public class PlayerController : MonoBehaviour
{
    ...
    // New method to handle the actual size-up effect
    private void PerformSizeUp()
    {
        // Calculate and apply new scale here
        // This would contain the actual scaling logic that previously happened in OnPlayerLevelUp
        // For example:
        if (enableMetamorphosis)
        {
        ...
        // Show "Size Up!" text when the player actually grows
        if (uiHelper != null)
        {
