...
public class UIHelper : MonoBehaviour
{
    ...
    // Reference to the ally ants button
    [SerializeField] private Button allyAntsButton;
    ...
    public void OnAllyAntsPanelClicked()
    {
        ...
        if (allyAntsButton != null)
        {
            allyAntsButton.interactable = false;
        }
    ...
    {
        // Re-enable the button when the panel is closed
        if (allyAntsButton != null)
        {
            allyAntsButton.interactable = true;
        }
