...
public class EnemyAI : MonoBehaviour
{
    ...
    private void HandleDeath()
    {
        ...
        // Make sure we interrupt any current animations and play death animation
        if (animController != null)
        {
            ...
            // Small delay to ensure other animations have a chance to reset
            StartCoroutine(PlayDeathAnimationAfterReset());
        }
    ...
    private IEnumerator PlayDeathAnimationAfterReset()
    {
        // Small delay to ensure other animations have time to stop
