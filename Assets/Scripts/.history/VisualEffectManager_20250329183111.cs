...
public class VisualEffectManager : MonoBehaviour
{
    ...
    private IEnumerator AnimateXPSymbol(GameObject xpSymbol, GameObject player, Vector3 targetPos)
    {
        ...
        // Update XP UI - using the correct method
        PlayerInventory playerInventory = FindObjectOfType<PlayerInventory>();
        if (playerInventory != null)
        {
            // Use AddExperience instead of GainExperiencePoints
            playerInventory.AddExperience(xpPerSymbol);
        }
    ...
    private IEnumerator FlyXPSymbolToCounter(GameObject symbol, Vector3 startPos)
    {
        ...
        while (elapsed < duration)
        {
            ...
            {
                // Remove this line that references PlayXPSound
                // PlayXPSound();
                hasSoundPlayed = true;
            }
