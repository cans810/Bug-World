...
public class EnemyAI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Direct animation override as last resort for when both moving and attacking
        if (isMoving && isAttacking && hasAttackWalkingAnimation && animController != null && animController.Animator != null)
        {
            // Directly force the AttackWalking animation every frame
            animController.Animator.SetBool("AttackWalking", true);
