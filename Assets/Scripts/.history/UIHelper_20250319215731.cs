...
public class UIHelper : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Find and cache player attributes
        if (cachedPlayerAttributes == null) {
            cachedPlayerAttributes = FindObjectOfType<PlayerAttributes>();
            
            if (cachedPlayerAttributes == null) {
                Debug.LogError("UIHelper: Cannot find PlayerAttributes component in the scene!");
                return;
            }
        }
    }
    ...
    public void DebugAttributePoint() {
        // First ensure we have a valid reference to PlayerAttributes
        if (cachedPlayerAttributes == null) {
            cachedPlayerAttributes = FindObjectOfType<PlayerAttributes>();
        ...
        // Call ApplyAttributeEffects instead of trying to invoke the event directly
        // This method will apply changes and trigger the appropriate events
        cachedPlayerAttributes.ApplyAttributeEffects();
