...
public class BorderVisualizer : MonoBehaviour
{
    ...
    [SerializeField] private Color radiusColor = Color.yellow; // Color of the radius line
    ...
    private void CreateVisualSphere()
    {
        ...
        {
            // Create a GameObject for the radius line
            ...
            visualSphere = radiusObj; // Store reference for later access
        }
        else
        {
    ...
    // Allow toggling between radius and sphere visualization at runtime
    public void ToggleRadiusVisualization(bool showRadiusOnly)
    {
        // Only proceed if there's a change
        if (showRadiusOnly != showRadius)
        {
