...
public class PlayerController : MonoBehaviour
{
    ...
    // Update OnTriggerStay for level restrictions
    private void OnTriggerStay(Collider other)
    {
        // Check if this is a MapBorder with level restrictions
        if (other.gameObject.layer == LayerMask.NameToLayer("MapBorder"))
        {
            string borderName = other.gameObject.name;
            ...
            // If no level requirement, skip this check
            ...
            {
                // Player meets level requirement - update their border name
