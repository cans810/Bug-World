...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (playerHitbox != null)
        {
            ...
            playerHitbox.OnEnemyDeath += HandleEnemyDeath;
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("MapBorder"))
        {
            ...
            if (borderName.StartsWith("MapBorder") && 
               (borderName == "MapBorder2" || 
                ...
                borderName == "MapBorder5") || borderName == "MapBorder6")
            {
    ...
    // Modify the HandleEnemyDetected method to remove discovery logic
    ...
    // Add this method to handle enemy deaths
    private void HandleEnemyDeath(LivingEntity enemy)
    {
        ...
        if (isEnemy)
        {
            // Get the entity name from the enemy
            string entityName = enemy.gameObject.name;
