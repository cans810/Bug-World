...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private float collectCooldown = 0.1f; // Add a small cooldown between collections
    ...
    public bool CanCollectItems()
    {
        ...
        // Check if we've passed the cooldown period
    ...
    // Add this method to temporarily block collection (useful for animations)
    public void SetCanCollect(bool enabled)
    {
        canCollect = enabled;
    }
}