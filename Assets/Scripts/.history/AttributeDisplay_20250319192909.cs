...
public class AttributeDisplay : MonoBehaviour
{
    ...
    public void ShowPanel(bool force = false)
    {
        if (attributesPanel != null)
        {
            ...
            Debug.Log($"AttributeDisplay.ShowPanel called. Panel active: {attributesPanel.activeSelf}, Force: {force}");
    ...
    private void UpdateDisplay()
    {
        if (playerAttributes != null)
        {
            ...
            // Update recovery (max 100)
            if (recoveryValueText != null)
                recoveryValueText.text = $"{playerAttributes.RecoveryPoints}/100";
            ...
            if (recoveryButton != null)
                recoveryButton.interactable = playerAttributes.AvailablePoints > 0 && playerAttributes.RecoveryPoints < 100;
        }
    }
