...
public class LoadGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Loading bar fill image is not assigned!");
            return;
        }
        
        // Ensure image is configured correctly
        if (loadingBarFill.type != Image.Type.Filled)
        {
            Debug.LogWarning("Loading bar fill image is not set to Filled type!");
