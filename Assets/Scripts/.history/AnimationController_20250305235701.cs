...
public class AnimationController : MonoBehaviour
{
    ...
    public void SetAttackWalking(bool attackWalking)
    {
        ...
        {
            // Add debugging
            Debug.Log($"Setting AttackWalking to {attackWalking} - HasAnimation={HasAnimation("AttackWalking")}");
            
            // Set the parameter if it exists
            if (HasAnimation("AttackWalking"))
            {
                Debug.Log($"Setting Animator.SetBool('AttackWalking', {attackWalking})");
                animator.SetBool("AttackWalking", attackWalking);
                
                // Verify parameter was set
                Debug.Log($"After setting, AttackWalking param = {animator.GetBool("AttackWalking")}");
            }
            else
            {
                ...
                animator.SetBool(walkingParam, attackWalking);
                animator.SetBool(attackingParam, attackWalking);
            }
        }
    }
}