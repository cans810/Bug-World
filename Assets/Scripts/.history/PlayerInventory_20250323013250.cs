...
public class PlayerInventory : MonoBehaviour
{
    ...
    // Modify the OnLevelUp event handler to check for rock barrier removal
    public void LevelUp()
    {
        CurrentLevel++;
        ...
        // Calculate attribute points (1 per level)
        ...
        ExperienceForNextLevel = GetExperienceRequiredForNextLevel(Experience);
