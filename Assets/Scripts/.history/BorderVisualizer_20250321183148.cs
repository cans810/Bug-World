...
public class BorderVisualizer : MonoBehaviour
{
    ...
    // Track the player's collision with this border
    private bool isPlayerTouchingBorder = false;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            // Only allow the player to "enter" if they meet the level requirement
    ...
    // Add this method to handle exiting borders
