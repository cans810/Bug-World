...
public class PlayerController : MonoBehaviour
{
    ...
    private void UpdateCameraSettings(int level)
    {
        ...
        {
            cameraController.SetCameraParameters(2.35f, 3.13f);
        }
        else if (level >= 7)
        {
            cameraController.SetCameraParameters(1.96f, 2.65f);
        }
        else if (level >= 2)
        {
            cameraController.SetCameraParameters(1.84f, 2.42f);
        }
        else
        {
            // Default settings for levels 1-4
            cameraController.SetCameraParameters(1.4f, 2.0f);
        }
    }
