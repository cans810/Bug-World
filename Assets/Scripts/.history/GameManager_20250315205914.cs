...
public class GameManager : MonoBehaviour
{
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (playerAttributes != null)
        {
            ...
            // Calculate and set available points correctly
            // This is based on level minus spent points
            int availablePoints = (gameData.currentLevel - 1) - 
                (gameData.currentStrength + gameData.currentVitality + 
                 gameData.currentAgility + gameData.currentIncubation);
            SetPrivateField(playerAttributes, "availablePoints", Mathf.Max(0, availablePoints));
            
            // Recalculate available points based on level and already spent points
