...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        // In the movement code, apply the speed multiplier
        float speedMultiplier = playerAttributes != null ? playerAttributes.SpeedMultiplier : 1f;
        // Apply the multiplier to your movement calculation
        float moveSpeed = currentSpeed * speedMultiplier;
    }
