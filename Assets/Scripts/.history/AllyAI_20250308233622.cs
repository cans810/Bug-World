...
public class AllyAI : MonoBehaviour
{
    ...
    // Add this method to your game manager or scene controller
    private void SetupAtmosphericLighting()
    {
        // Create a global light
        GameObject lightObj = new GameObject("AtmosphericLight");
        Light light = lightObj.AddComponent<Light>();
        light.type = LightType.Directional;
        light.intensity = 0.7f;
        light.color = new Color(0.9f, 0.8f, 0.7f); // Warm sunset color
