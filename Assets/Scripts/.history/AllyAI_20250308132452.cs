...
public class AllyAI : MonoBehaviour
{
    ...
    private float lootPickupDistance = 1.0f; // Distance at which to pick up loot
    ...
    public void LootDetected(Transform loot)
    {
        ...
        // Store the detected loot and switch to loot-seeking mode
        detectedLoot = loot;
        ...
        {
            Debug.Log($"{gameObject.name} detected loot and is moving to collect it");
        }
    }
