...
public class VisualEffectManager : MonoBehaviour
{
    ...
    private void TriggerUICounterAnimation(string resourceType)
    {
        ...
        // Call the appropriate update method based on resource type
        switch (resourceType.ToLower())
        {
            case "coin":
                ...
                break;
            case "xp":
                // Assuming UpdateXPDisplay exists and works like other methods
                uiHelper.UpdateExperienceDisplay(playerInventory.currentXP, playerInventory.xpRequiredForNextLevel);
                break;
            case "chitin":
                // Use method known to exist in UIHelper
                uiHelper.UpdateChitinDisplay(playerInventory.chitinCount, playerInventory.maxChitinCapacity);
                break;
            case "crumb":
                // Use method known to exist in UIHelper
                uiHelper.UpdateCrumbDisplay(playerInventory.crumbCount, playerInventory.maxCrumbCapacity);
                break;
            case "egg":
                // Use method known to exist in UIHelper
                uiHelper.UpdateEggDisplay(playerInventory.eggCount, playerInventory.maxEggCapacity);
                break;
            default:
