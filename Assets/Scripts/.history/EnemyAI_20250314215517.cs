...
public class EnemyAI : MonoBehaviour
{
    ...
    {
        // Ensure wandering behavior is completely disabled
        if (wanderingBehavior != null)
        {
            wanderingBehavior.enabled = false;
            wanderingBehavior.StopAllCoroutines();  // Stop any ongoing coroutines in the wandering behavior
        }
        ...
        // Stop all coroutines in this component
        StopAllCoroutines();
        
        // Ensure the rigidbody is frozen if present
        ...
        // Ensure the enemy is in the death animation state
        if (animController != null)
        {
            animController.SetDead();
        }
        
        // Disable the character controller if present
        ...
        // Ensure we don't process any more updates
        enabled = false;
    }
