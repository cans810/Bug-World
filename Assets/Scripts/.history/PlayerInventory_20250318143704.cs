...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void LoadInventoryData(GameData gameData)
    {
        if (gameData == null)
        {
            Debug.LogError("Cannot load inventory data: GameData is null");
            return;
        }
        
        Debug.Log("Loading inventory data into PlayerInventory");
        
        // Set loading flag
        isLoadingData = true;
        
        // Load all inventory data directly
        _experience = gameData.currentXP;
        _chitinCount = gameData.currentChitin;
        _crumbCount = gameData.currentCrumb;
        ...
        _coinCount = gameData.currentCoin;
        ...
        Debug.Log($"PlayerInventory loaded data: Level={CurrentLevel}, XP={_experience}, " +
                  $"Chitin={_chitinCount}, Crumb={_crumbCount}, Egg={currentEggCount}, " +
                  $"MaxEggCapacity={maxEggCapacity}, Coin={_coinCount}");
    }
