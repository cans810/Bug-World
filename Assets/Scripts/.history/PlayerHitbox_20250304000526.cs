...
public class PlayerHitbox : MonoBehaviour
{
    ...
    [SerializeField] private bool allowMovementWhileAttacking = true;
    ...
    private void Start()
    {
        ...
        if (animController == null && showDebugMessages)
        {
            Debug.LogError("No AnimationController found on player or its children!");
        }
    ...
    private IEnumerator PerformAttack()
    {
        ...
        // Use the AnimationController to set the attack state
        if (animController != null)
        {
            // Instead of using SetAttacking which resets all states,
            // we'll directly set the attack parameter to true
            // This allows walking animation to continue playing
            if (allowMovementWhileAttacking)
            {
                ...
                if (animator != null)
                {
                    ...
                    if (showDebugMessages)
                    {
                        Debug.Log("Started attack animation while preserving movement state");
                    }
                }
            }
            else
            {
                // Use the standard method if movement during attack is not allowed
    ...
    {
        // Use the AnimationController to end the attack state
        if (animController != null)
        {
            if (allowMovementWhileAttacking)
            {
                ...
                if (animator != null)
                {
                    ...
                    if (showDebugMessages)
                    {
                        Debug.Log("Stopped attack animation while preserving movement state");
                    }
                }
            }
            else
