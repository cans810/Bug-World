...
public class AIWandering : MonoBehaviour
{
    ...
    [SerializeField] private float playerBorderAvoidanceDistance = 10f; // Increased distance to ensure enemies never get close
    ...
    private bool IsPositionTooCloseToNest(Vector3 position)
    {
        ...
        if (avoidPlayerBorder && playerBorderTransform != null)
        {
            ...
            tooCloseToBorder = distanceToBorder < (playerBorderRadius + playerBorderAvoidanceDistance);
        }
    ...
    private Vector3 GetSafeWaypoint()
    {
        ...
        for (int attempt = 0; attempt < 8; attempt++)
        {
            ...
            // Additional check specifically for player border
            if (avoidPlayerBorder && playerBorderTransform != null)
            {
