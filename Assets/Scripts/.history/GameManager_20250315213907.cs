...
public class GameManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        if (playerInventory != null)
        {
            ...
            gameData.hasCollectedChitinFirstTime = playerInventory.HasCollectedChitinFirstTime;
            gameData.hasCollectedCrumbFirstTime = playerInventory.HasCollectedCrumbFirstTime;
        }
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (playerInventory != null)
        {
            ...
            // Add these lines
            playerInventory.HasCollectedChitinFirstTime = gameData.hasCollectedChitinFirstTime;
            playerInventory.HasCollectedCrumbFirstTime = gameData.hasCollectedCrumbFirstTime;
        }
