...
public class PlayerController : MonoBehaviour
{
    ...
    // Update the attack method if it exists to properly register the player as the killer
    public void PerformAttack()
    {
        ...
        {
            // Deal damage to the target, passing the player entity as the damage source
            target.TakeDamage(CalculateDamage(), livingEntity);
        }
