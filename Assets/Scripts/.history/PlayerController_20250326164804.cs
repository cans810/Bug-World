...
public class PlayerController : MonoBehaviour
{
    ...
    // Update the PlayMetamorphosisEffect method to include the camera animation
    private void PlayMetamorphosisEffect()
    {
        ...
        // Play metamorphosis camera animation
        CameraAnimations cameraAnimations = FindObjectOfType<CameraAnimations>();
        if (cameraAnimations != null)
        {
            cameraAnimations.AnimateMetamorphosis(transform);
        }
        else
        {
            // Fallback to just camera shake if animations component not found
            CameraController cameraController = FindObjectOfType<CameraController>();
        ...
        if (uiHelper != null)
        {
            // Check if sizeUpText component exists
            if (uiHelper.sizeUpText != null)
            {
            ...
            {
                // Fall back to regular notification if sizeUpText is not set
