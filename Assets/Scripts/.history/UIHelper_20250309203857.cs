...
public class UIHelper : MonoBehaviour
{
    ...
    public void ShowInformText(string text)
    {
        ...
        // If already showing, just update the text without restarting animation
        ...
        // Reset animator state before setting new parameters
        textAnimator.Rebind();
        textAnimator.Update(0f);
        
        // Trigger animation
        textAnimator.SetBool("Dissappear", false);
    ...
    public void HideInformText()
    {
        ...
        if (textAnimator != null)
        {
            // Set animation parameters only once
