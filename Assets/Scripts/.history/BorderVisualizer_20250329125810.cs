...
public class BorderVisualizer : MonoBehaviour
{
    ...
    private void DrawCapsulePerimeter()
    {
        ...
        // For X or Z axis aligned capsules, create a stadium shape
        ...
        for (int i = 0; i < segments; i++)
        {
            ...
            // First part - draw the first semicircle
            if (angle < Mathf.PI)
            {
            ...
            // Second part - draw the second semicircle
            else
            {
                if (direction == 0) // X-axis capsule
                {
            ...
            // For the straight sections, we need to adjust the x/z based on angle
            if (angle >= Mathf.PI/2 && angle < 3*Mathf.PI/2)
            {
                ...
                if (direction == 0) // X-axis capsule
                {
                    ...
                    {
                        float t = (angle - Mathf.PI/2) / (Mathf.PI/2);
            ...
            else if (angle >= 3*Mathf.PI/2 || angle < Mathf.PI/2)
            {
                ...
                if (direction == 0) // X-axis capsule
                {
                    ...
                    {
                        float t = (angle - 3*Mathf.PI/2) / (Mathf.PI/2);
