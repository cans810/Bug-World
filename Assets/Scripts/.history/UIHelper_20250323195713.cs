...
public class UIHelper : MonoBehaviour
{
    ...
    public void OnPlayerLevelUp(int newLevel)
    {
        ...
        // If you want to add a button to show attributes manually:
    ...
    // Add a method to show a button that players can tap to see attributes
    public void ShowAttributesButton(bool show)
    {
        if (attributesButton != null)
        {
            attributesButton.gameObject.SetActive(show);
        }
    }

    // Add a method that can be called from a button
    public void OnShowAttributesButtonPressed()
    {
        AttributeDisplay attributeDisplay = FindObjectOfType<AttributeDisplay>();
        if (attributeDisplay != null)
        {
            attributeDisplay.ManuallyShowAttributePanel();
        }
    }
} 
