...
public class LivingEntity : MonoBehaviour
{
    ...
    [SerializeField] private string hitSoundEffectName = "Hit1";
    ...
    public void Heal(float amount)
    {
        ...
        // Store the actual amount healed
    ...
    // This method is called when an attack hits a target
    private void OnAttackHit(LivingEntity target)
    {
        // Play attack sound when hit connects
        PlayAttackSound();
        
        // Existing attack hit logic...
    }
    
    // Method to play attack sound
    ...
    // Find the method that handles attack damage and add the sound effect
    // This might be in a method like ApplyDamage, DealDamage, or similar
    public void ApplyDamage(float amount, LivingEntity attacker = null)
    {
        // Existing damage logic...
        
        // After damage is applied successfully:
        if (attacker != null && attacker.useSoundEffectManager && SoundEffectManager.Instance != null)
        {
            // Play attack sound from the attacker
            SoundEffectManager.Instance.PlaySound(attacker.attackSoundEffectName, attacker.transform.position);
        }
