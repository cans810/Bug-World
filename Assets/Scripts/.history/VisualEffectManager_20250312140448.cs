...
public class VisualEffectManager : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 crumbScale = new Vector3(1f, 1f, 1f);
    ...
    private IEnumerator AnimateResourceCollection(GameObject symbol, string type)
    {
        ...
        Vector3 targetScale = type == "chitin" ? chitinScale : crumbScale;
        ...
        while (elapsed < chitinFlyDuration)
        {
            ...
            symbol.transform.localScale = targetScale * pulseScale;
