...
public class PlayerInventory : MonoBehaviour
{
    ...
    { 
        ...
        set 
        {
            ...
            OnEggCountChanged?.Invoke(currentEggCount);
        }
    }
    ...
    private void Start()
    {
        ...
        // Subscribe to PlayerAttributes incubation changes
        PlayerAttributes playerAttributes = GetComponent<PlayerAttributes>();
        if (playerAttributes != null)
        {
            playerAttributes.OnIncubationChanged += SyncWithPlayerAttributes;
        }
    }
    ...
    public void LoadEggData(GameData saveData)
    {
        ...
        Debug.Log($"Loaded egg data: {currentEggCount}/{maxEggCapacity}");
    }
    ...
    public void SyncWithPlayerAttributes()
    {
        ...
        if (playerAttributes != null)
        {
            // Update max capacity based on PlayerAttributes
            maxEggCapacity = playerAttributes.MaxEggCapacity;
            
            // Ensure current count doesn't exceed new capacity
            currentEggCount = Mathf.Min(currentEggCount, maxEggCapacity);
