...
public class ArrowIndicator : MonoBehaviour
{
    ...
    private void UpdateArrowPosition()
    {
        ...
        if (!isOnScreen || (distance > reachDistance))
        {
            ...
            // Just set the Z rotation directly - this is the key fix
            ...
            // Use non-uniform scale to prevent warping - keep Z scale small but non-zero
            float baseScale = arrowSize * pulse;
            arrowObject.transform.localScale = new Vector3(baseScale, baseScale, 0.1f);
        }
        else
        {
