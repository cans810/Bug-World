...
public class AllyAI : MonoBehaviour
{
    ...
    private void FollowPlayerBehavior()
    {
        ...
        {
            // Calculate player movement since last check
            if (lastPlayerPosition != Vector3.zero)
            {
                ...
                {
                    playerIsMoving = true;
                    // Use the player's actual forward direction instead of movement vector
                    // This better represents the input direction
        ...
        else
        {
            ...
            // Always use the player's forward direction as our movement direction
            // This directly mimics the player's input rather than calculating our own path
