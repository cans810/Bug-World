...
public class EnemyAI : MonoBehaviour
{
    ...
    {
        // Disable this AI component when entity dies
        ...
        // Disable any colliders that might still trigger interactions
        ...
        // Make sure the death animation is played
        if (animController != null)
        {
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        // Draw minimal attack distance
        Gizmos.color = Color.magenta;
        Gizmos.DrawWireSphere(transform.position, minAttackDistance);
        
        // Draw detection follow range
        Gizmos.color = Color.yellow;
        Gizmos.DrawWireSphere(transform.position, detectionFollowRange);
    }
} 