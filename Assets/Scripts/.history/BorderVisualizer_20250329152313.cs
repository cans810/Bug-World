...
public class BorderVisualizer : MonoBehaviour
{
    ...
    public void ActivateEntityIcons()
    {
        ...
        {
            Debug.Log($"Failed to activate icons for {gameObject.name}: " +
                     $"hasBeenDisabled={hasBeenDisabled}, " +
                     $"entityContainedIcons={(entityContainedIcons != null ? "assigned" : "null")}");
        }
    }
    ...
    // Add these helper methods to BorderVisualizer
    public bool IsDisabled()
    {
        return hasBeenDisabled;
    }

    public bool HasEntityIcons()
    {
        return entityContainedIcons != null;
    }
} 