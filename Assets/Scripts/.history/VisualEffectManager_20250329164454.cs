    ...
    private void InitializeUIElementPools()
    {
        ...
        if (uiChitinIconPrefab != null)
        {
            ...
            for (int i = 0; i < 10; i++) // Pool size of 10
            {
                ...
                GameObject icon = Instantiate(uiChitinIconPrefab, canvasSafeArea.transform);
        ...
        if (uiXPIconPrefab != null)
        {
            ...
            uiXPPool.transform.SetParent(transform);
            uiElementPools["uiXP"] = new Queue<GameObject>();
            
            for (int i = 0; i < 10; i++) // Pool size of 10
            {
                GameObject icon = Instantiate(uiXPIconPrefab, canvasSafeArea.transform);
                icon.SetActive(false);
