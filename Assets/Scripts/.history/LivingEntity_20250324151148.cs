...
public class LivingEntity : MonoBehaviour
{
    ...
    public virtual void Revive()
    {
        ...
        // IMPORTANT: Re-enable the character controller and player components
        if (gameObject.CompareTag("Player"))
        {
            ...
            // Enable the character controller if it exists
            ...
            // Enable the rigidbody if it exists
            ...
            // Reset any animation parameters
        ...
        // Fire an OnRevive event if you have one
        if (OnRevive != null)
        {
            OnRevive.Invoke();
        }
    ...
    // Ensure attack cooldown messages are delegated to UIHelper
    public void StartAttackCooldown()
    {
        // Delegate UI updates to PlayerController or UIHelper
        if (playerController != null)
        {
            playerController.HandleAttackCooldown();
        }
    }
}