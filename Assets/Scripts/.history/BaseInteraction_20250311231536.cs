...
public class BaseInteraction : MonoBehaviour
{
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (exitingInventory != null && exitingInventory == playerInventory)
        {
            ...
            {
                Debug.Log("Player left the base. Healing stopped.");
            }
        }
    }
    ...
    private void StopHealing()
    {
        ...
        if (playerOutline != null)
        {
            Debug.Log($"Resetting outline color from {playerOutline.OutlineColor} to {originalOutlineColor}");
