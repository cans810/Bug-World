...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 offset = new Vector3(0f, 2f, -4f); // No horizontal offset, only height and distance
    
    [Header("Camera Settings")]
    [SerializeField] private float smoothSpeed = 10f;
    [SerializeField] private bool lookAtTarget = true;
    [SerializeField] private Vector3 targetOffset = new Vector3(0f, 0.5f, 0f); // Look at point on player
    ...
    private Vector3 CalculateCameraPosition()
    {
        ...
        // Move backward from player based on zoom
        position -= playerForward * currentZoom;
    ...
    private Vector3 GetZoomedOffset()
    {
        ...
        return new Vector3(0, zoomY, zoomZ); // Force X to 0 to center player
    }
}