...
public class GameManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        if (incubator != null)
        {
            ...
            // Also save the max egg capacity
            gameData.currentMaxEggCapacity = incubator.GetMaxEggCapacity();
        }
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (incubator != null)
        {
            // Make sure capacity is loaded before setting egg count
            incubator.SetMaxCapacity(gameData.currentMaxEggCapacity);
