...
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    [SerializeField] private string[] touchableUILayers = new string[] { "TouchableUI", "PlayerNest1","PlayerNest2","PlayerNest3","PlayerNest4","PlayerNest5","PlayerNest6","PlayerNest7","PlayerNest8","PlayerNest9","PlayerNest10" }; // UI elements on these layers can be touched through
