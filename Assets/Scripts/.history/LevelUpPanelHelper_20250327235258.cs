...
public class LevelUpPanelHelper : MonoBehaviour
{
    ...
    // Add this to LevelUpPanelHelper.cs
    ...
    {
        // Disable player movement when showing rewards
        if (playerController != null)
        {
            playerController.SetCanMove(false);
            Debug.Log("Disabled player movement for rewards display");
        }
    ...
    public void ShowLevelUpRewards(int level)
    {
        // Disable player movement when showing rewards
        if (playerController != null)
        {
        ...
        // Existing reward display code...
    }

    public void CloseRewardsPanel()
    {
        // Re-enable player movement when closing rewards
        if (playerController != null)
        {
            playerController.SetCanMove(true);
            Debug.Log("Re-enabled player movement after rewards");
        }
        
        // Existing panel close code...
    }
}
