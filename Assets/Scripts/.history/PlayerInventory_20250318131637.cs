...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void SaveGameData(GameData data)
    {
        ...
        data.currentXP = TotalExperience;
        data.currentChitin = ChitinCount;
        data.currentCrumb = CrumbCount;
        data.currentEgg = CurrentEggCount;
        data.maxEggCapacity = MaxEggCapacity;
        data.hasYetToCollectChitin = HasYetToCollectChitin;
        data.hasYetToCollectCrumb = HasYetToCollectCrumb;
        data.currentCoin = CoinCount;
        
        Debug.Log($"Saved inventory data: Level={data.currentLevel}, XP={data.currentXP}, " +
                  $"Chitin={data.currentChitin}, Crumb={data.currentCrumb}, " +
                  $"Egg={data.currentEgg}, MaxEggCapacity={data.maxEggCapacity}, " +
                  $"Coins={data.currentCoin}");
    }
    ...
    public void LoadGameData(GameData data)
    {
        ...
        // Set loading state to prevent unwanted side effects
        SetLoadingDataState(true);
        
        // Load basic inventory data
        _chitinCount = data.currentChitin;
        _crumbCount = data.currentCrumb;
        currentEggCount = data.currentEgg;
        maxEggCapacity = data.maxEggCapacity;
        hasYetToCollectChitin = data.hasYetToCollectChitin;
        hasYetToCollectCrumb = data.hasYetToCollectCrumb;
        currentCoinCount = data.currentCoin;
        
        // Load experience and level
        _experience = data.currentXP;
        int currentLevel = data.currentLevel;
        
        // Update UI
        ForceUpdateUI();
        
        Debug.Log($"Loaded inventory data: Level={data.currentLevel}, XP={data.currentXP}, " +
                  $"Chitin={data.currentChitin}, Crumb={data.currentCrumb}, " +
                  $"Egg={data.currentEgg}, MaxEggCapacity={data.maxEggCapacity}, " +
                  $"Coins={data.currentCoin}");
