...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandlePlayerDeath()
    {
        ...
        // Start auto-revive coroutine with countdown
        StartCoroutine(ReviveAfterDelay(5f));
        
        // The initial message is now set in the ReviveAfterDelay coroutine
    ...
    private IEnumerator ReviveAfterDelay(float delay)
    {
        ...
        if (uiHelper != null && uiHelper.informPlayerText != null)
            uiHelper.informPlayerText.text = $"You are dead. Revive in {delay} seconds.";
