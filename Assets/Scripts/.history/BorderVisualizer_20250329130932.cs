...
public class BorderVisualizer : MonoBehaviour
{
    ...
    private void DrawBoxPerimeter()
    {
        ...
        for (int i = 0; i < segments; i++)
        {
            // 1. Apply center offset
            Vector3 point = corners[i] + center;
            
            // 2. Set y to perimeter height
            point.y = perimeterHeight - center.y;
            
            // 3. Transform point to world space to get correct rotation
