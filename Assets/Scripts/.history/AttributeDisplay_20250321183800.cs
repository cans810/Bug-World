...
public class AttributeDisplay : MonoBehaviour
{
    ...
    private void UpdateDisplay()
    {
        if (playerAttributes != null)
        {
            ...
            if (speedBonusText != null)
                speedBonusText.text = $"+{(playerAttributes.SpeedMultiplier - 1) * 100:F0}% Speed";
    ...
    public void UpdateDisplayWithValues(int strength, int vitality, int agility, int incubation, int recovery, int speed, int availablePoints)
    {
        ...
        // Update strength (max 20)
        if (strengthValueText != null)
            strengthValueText.text = $"{strength}/20";
            
        if (strengthBonusText != null && playerAttributes != null)
            strengthBonusText.text = $"+{(playerAttributes.StrengthMultiplier - 1) * 100:F0}% Damage";
            
        // Update vitality (max 20)
        if (vitalityValueText != null)
            vitalityValueText.text = $"{vitality}/20";
        ...
        // Update agility (max 20)
        if (agilityValueText != null)
            agilityValueText.text = $"{agility}/20";
            
        if (agilityBonusText != null && playerAttributes != null)
            agilityBonusText.text = $"-{(playerAttributes.AgilityMultiplier - 1) * 100:F0}% Attack Cooldown";
            
        // Update recovery (max 15)
        if (recoveryValueText != null)
            recoveryValueText.text = $"{recovery}/15";
        ...
        // Update button interactability
        if (strengthButton != null)
            strengthButton.interactable = availablePoints > 0 && strength < 20;
            
        if (vitalityButton != null)
            vitalityButton.interactable = availablePoints > 0 && vitality < 20;
            
        if (incubationButton != null)
            incubationButton.interactable = availablePoints > 0 && incubation < 20;
            
        if (agilityButton != null)
            agilityButton.interactable = availablePoints > 0 && agility < 20;
            
        if (recoveryButton != null)
            recoveryButton.interactable = availablePoints > 0 && recovery < 15;
            
        if (speedButton != null)
            speedButton.interactable = availablePoints > 0 && speed < 25;
    }
    ...
    public void UpdateDisplayWithValues(int strength, int vitality, int agility, int incubation, int availablePoints)
    {
        ...
        UpdateDisplayWithValues(strength, vitality, agility, incubation, 0, 0, availablePoints);
