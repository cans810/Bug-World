    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (ownerIsPlayerOrAlly && otherIsInsect)
        {
            ...
            if (insectEntity != null && !insectEntity.IsDead)
            {
                ...
                {
                    string entityName = insectEntity.name.ToLower();
                    Debug.Log($"ENTITY HITBOX: Player detected insect '{entityName}', triggering discovery");
                    ...
                    if (controller != null)
                    {
                        Debug.Log($"Calling discovery for entity type: {entityType}");
                        controller.CheckAndDiscoverEntity(entityType);
                    }
                    else
                    {
