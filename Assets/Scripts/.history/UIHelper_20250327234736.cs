...
public class UIHelper : MonoBehaviour
{
    ...
    // Modify the ShowLevelUpPanel method
    public void ShowLevelUpPanel(bool show)
    {
        if (LevelUpPanel != null)
        {
            ...
            // Disable movement when showing panel
            if (show)
            {
                DisablePlayerMovement();
            }
            // Only enable movement when hiding panel if no other panels are active
            else if (!attributesPanel.activeInHierarchy && 
                     !(nestMarketPanel != null && nestMarketPanel.activeInHierarchy) &&
                     !(revivalPanel != null && revivalPanel.activeInHierarchy))
            {
