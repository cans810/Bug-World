...
public class UIHelper : MonoBehaviour
{
    ...
    public void ShowPersistentInformText(string message)
    {
        ...
        {
            // Set rich text support to true if not already set
            informPlayerText.richText = true;
            
            // Set the text (can now include color tags)
    ...
    public void ShowInformText(string message, float duration = 6f)
    {
