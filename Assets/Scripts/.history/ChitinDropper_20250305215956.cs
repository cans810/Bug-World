...
public class ChitinDropper : MonoBehaviour
{
    ...
    [SerializeField] private float upwardForceMin = 5f;  // Current value is good
    [SerializeField] private float upwardForceMax = 7f;  // Current value is good
    [SerializeField] private float horizontalForce = 3f; // REDUCED from 20f - much less horizontal movement
    [SerializeField] private float explosionRadius = 0.5f; // REDUCED from 2f - smaller radius
