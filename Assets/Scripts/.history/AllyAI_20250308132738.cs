...
public class AllyAI : MonoBehaviour
{
    ...
    public void LootDetected(Transform loot)
    {
        ...
        // Check if we're already very close to the loot - if so, don't bother changing mode
        // This prevents instant pickup if the hitbox is large, ensuring ally always approaches loot
        float distanceToLoot = Vector3.Distance(transform.position, loot.position);
