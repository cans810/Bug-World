...
public class GameManager : MonoBehaviour
{
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        if (playerAttributes != null)
        {
            ...
            // Make sure incubation points are properly set
            SetPrivateField(playerAttributes, "_incubationPoints", gameData.currentIncubation);
            
            // Debug log to verify incubation points
            Debug.Log($"Set incubation points to {gameData.currentIncubation}, resulting in MaxEggCapacity = {playerAttributes.MaxEggCapacity}");
