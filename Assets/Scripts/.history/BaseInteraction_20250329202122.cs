...
public class BaseInteraction : MonoBehaviour
{
    ...
    private IEnumerator PlayXPGainAfterChitinDeposit(int xpAmount, int startXP, int targetXP)
    {
        ...
        if (visualEffectManager != null)
        {
            ...
            // Since each chitin = 1 XP, the xpAmount equals the number of chitins deposited
            ...
            if (uiEffects != null)
            {
                // Pass the deposited chitin amount instead of current inventory count
                uiEffects.PlayChitinDepositEffect(depositedChitinAmount, xpAmount);
            ...
            if (playerInventory != null)
            {
                ...
                // Debug log to verify
                Debug.Log($"Added {xpAmount} XP from {depositedChitinAmount} chitin (1 XP per chitin)");
            }
