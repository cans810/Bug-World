...
public class CameraAnimations : MonoBehaviour
{
    ...
    [SerializeField] private float mapViewHeight = 30f; // Reduced from 60f to keep camera closer
    [SerializeField] private float mapViewDuration = 1.5f; // Time to transition to map view
    [SerializeField] private float mapCameraAngle = 65f; // Reduced from 75f for better perspective
