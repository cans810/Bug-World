...
public class VisualEffectManager : MonoBehaviour
{
    ...
    public void PlayLevelUpEffect(Vector3 playerPosition, System.Action onCompleteCallback = null)
    {
        ...
        for (int i = 0; i < symbolCount; i++)
        {
            ...
            // Wider horizontal clustering but same vertical staggering
            Vector3 randomOffset = new Vector3(
                Random.Range(-0.25f, 0.25f),  // Increased from -0.1f/0.1f to -0.25f/0.25f for wider spread
                0.15f * i,
                Random.Range(-0.25f, 0.25f)   // Increased Z spread as well for more volume
            );
