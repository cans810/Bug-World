...
public class PlayerController : MonoBehaviour
{
    ...
    // Improved method to show arrows during metamorphosis that are scaled to player size
    private void ShowMetamorphosisArrows()
    {
        ...
        // Create a screen center arrow - positioned lower
        ...
        if (sizeField != null)
            sizeField.SetValue(centerArrow, 0.04f + (transform.localScale.x * 0.01f)); // Size based on player scale
