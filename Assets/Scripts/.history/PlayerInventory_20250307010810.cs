...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void DepositCrumbsAtBase(int amount)
    {
        ...
        // Add experience for depositing crumbs (5 XP per crumb)
        int xpGained = amount * 5; // Set this to whatever XP per crumb you want
        Experience += xpGained;
        
        // Debug logs to track XP gains
        Debug.Log($"XP SYSTEM: Deposited {amount} crumbs");
        Debug.Log($"XP SYSTEM: Gained {xpGained} XP (5 per crumb)");
