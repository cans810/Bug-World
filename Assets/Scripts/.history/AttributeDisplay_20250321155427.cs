...
public class AttributeDisplay : MonoBehaviour
{
    ...
    public void ShowPanel(bool show)
    {
        ...
        // Always check for animation in progress
        if (cameraAnimations != null && cameraAnimations.IsAnimationInProgress())
        {
            ...
            // IMPORTANT: Set a flag to show the panel later
    ...
    // Add this method to check if the panel should be shown after animation
    private void Update()
    {
