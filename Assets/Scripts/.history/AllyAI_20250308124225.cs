...
public class AllyAI : MonoBehaviour
{
    ...
    private void FollowPlayerBehavior()
    {
        ...
        // If we're close enough to player, enable wandering and update animation based on actual movement
        else
        {
            // Enable wandering when close to player
            if (wanderingBehavior != null)
                wanderingBehavior.SetWanderingEnabled(true);
            
            // Update animation based on whether the ally is actually moving from the wandering behavior
