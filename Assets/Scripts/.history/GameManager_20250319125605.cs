...
public class GameManager : MonoBehaviour
{
    ...
    public void SaveGame()
    {
        ...
        // Find all InsectIncubators and save their eggs
        InsectIncubator[] incubatorArray = FindObjectsOfType<InsectIncubator>();
        foreach (var incubator in incubatorArray)
        {
            incubator.SaveEggs(gameData);
        }
    ...
    private void ApplyLoadedDataToGameState()
    {
        ...
        // Find all InsectIncubators and load their eggs
        InsectIncubator[] incubatorInstances = FindObjectsOfType<InsectIncubator>();
        foreach (var incubator in incubatorInstances)
        {
            incubator.LoadEggs(gameData);
        }
    }
