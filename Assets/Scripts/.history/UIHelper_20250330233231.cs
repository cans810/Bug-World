...
public class UIHelper : MonoBehaviour
{
    ...
    {
        SoundEffectManager.Instance.PlaySound("ButtonClicked");
        thisIsYourNestPanel.SetActive(true);
        thisIsYourNestPanel.GetComponent<Animator>().SetBool("ShowUp", true);
        thisIsYourNestPanel.GetComponent<Animator>().SetBool("Hide", false);
