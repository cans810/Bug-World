...
public class EntityHitbox : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            // Instead of calling LootDetected, call a new method that only registers
            // the loot as a potential target, without initiating immediate pickup
            ownerAllyAI.RegisterLootInRange(other.transform);
