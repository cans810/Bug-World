...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField] private float currentZoom = 2f;
    ...
    [SerializeField] private float[] scaleMultipliers = new float[] { 1f, 1.2f, 1.4f, 1.6f, 1.8f, 2.0f };
    [SerializeField] private float[] zoomMultipliers = new float[] { 1f, 1.15f, 1.3f, 1.45f, 1.6f, 1.75f };
    [SerializeField] private float[] fovMultipliers = new float[] { 1f, 1.05f, 1.1f, 1.15f, 1.2f, 1.25f };

    [Header("Base Camera Settings")]
    [SerializeField] private Vector3 baseOffset = new Vector3(0f, 1.5f, -2f);
    ...
    private Vector3 GetCameraOffset()
    {
        ...
        Vector3 calculatedOffset = 
            ...
            upDirection * currentOffset.y +
            rightDirection * currentOffset.x;
    ...
    public void AdjustCameraForPlayerScale(float playerScale)
    {
        ...
        // Adjust offset
        currentOffset = baseOffset * zoomMultipliers[scaleIndex];
