...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // This method may have used MapBoundary to check if player is within boundaries
        // Since we've removed MapBoundary, just return as we're not enforcing boundaries now
        return;
    }
}