...
public class EnemyAI : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            HandleBoundaryHit(collision.contacts[0].normal);
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.gameObject.layer == LayerMask.NameToLayer("MapBorder"))
        {
            ...
            HandleBoundaryHit(directionToCenter);
        }
    }

    private void HandleBoundaryHit(Vector3 normal)
    {
        // Normalize the direction and keep it horizontal
        normal.y = 0;
        normal.Normalize();
        ...
        // Calculate a new direction (opposite of current forward with some randomness)
        ...
        if (wanderingBehavior != null)
        {
            ...
            // Force a new waypoint in our new direction
