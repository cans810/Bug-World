...
public class PlayerInventory : MonoBehaviour
{
    ...
    private IEnumerator PlayBarrierRemovalAnimation(BarrierRocksController barrier)
    {
        ...
        {
            // Try the common method name format - most likely one of these will work
            // Option 1: PlaySound method
            SoundEffectManager.Instance.PlaySound("RockBreak", 0.8f);
            
            // If the above doesn't work, comment it out and uncomment one of these alternatives:
            // Option 2: Play method
            // SoundEffectManager.Instance.Play("RockBreak", 0.8f);
            
            // Option 3: PlayEffectAt
            // SoundEffectManager.Instance.PlayEffectAt("RockBreak", barrier.transform.position, 0.8f);
        }
