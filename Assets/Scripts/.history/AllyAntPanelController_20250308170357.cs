...
public class AllyAntPanelController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Periodically update the all ants mode text
    ...
    {
        if (allAntsFollowModeOrderText == null || allAntsWanderModeOrderText == null)
            return;
        ...
        // Check if all ants are following
        bool allFollowing = true;
        bool allWandering = true;
        ...
        foreach (GameObject ant in allyAnts)
        {
            ...
            if (allyAI != null)
            {
                ...
                if (currentMode != AllyAI.AIMode.Wander)
                    allWandering = false;
            }
        }
        
        // Update follow text
        allAntsFollowModeOrderText.text = allFollowing ? "All Following" : "Custom";
        
        // Update wander text
        allAntsWanderModeOrderText.text = allWandering ? "All Wandering" : "Custom";
    }
}
