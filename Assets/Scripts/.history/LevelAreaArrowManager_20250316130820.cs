...
public class LevelAreaArrowManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Add arrow indicator component if it doesn't exist
        if (arrowIndicator == null)
        {
            arrowIndicator = gameObject.AddComponent<ArrowIndicator>();
            Debug.Log("Added ArrowIndicator component");
        }
    ...
    private void ShowArrowToArea(LevelAreaTarget area)
    {
        ...
        // Ensure arrow indicator exists
        EnsureArrowIndicatorExists();
    ...
    // Add this method to ensure the ArrowIndicator is properly set up
    private void EnsureArrowIndicatorExists()
    {
        if (arrowIndicator == null)
        {
            arrowIndicator = gameObject.AddComponent<ArrowIndicator>();
            Debug.Log("Created new ArrowIndicator component");
            
            // If you have a prefab for the arrow, assign it here
            // arrowIndicator.arrowPrefab = Resources.Load<GameObject>("ArrowPrefab");
        }
    }
} 