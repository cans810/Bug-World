...
public class LivingEntity : MonoBehaviour
{
    ...
    public void AddTargetInRange(LivingEntity target)
    {
        if (target != null && !targetsInRange.Contains(target))
        {
            ...
            {
                Debug.Log($"{name} added {target.name} to targets in range. Total targets: {targetsInRange.Count}");
            }
        }
    }
    ...
    public void RemoveTargetInRange(LivingEntity target)
    {
        if (target != null && targetsInRange.Contains(target))
        {
            ...
            if (showDebugMessages)
            {
                Debug.Log($"{name} removed {target.name} from targets in range. Total targets: {targetsInRange.Count}");
            }
        }
    }
    ...
    // Add this method to get all targets in range
    public List<LivingEntity> GetTargetsInRange()
    {
