...
public class AllyAI : MonoBehaviour
{
    ...
    private float positionChangeThreshold = 0.005f; // Minimum movement to consider as "moving"
    ...
    private void WanderBehavior()
    {
        ...
        float distanceMoved = Vector3.Distance(lastFramePosition, currentPosition);
        ...
        {
            // We're not moving enough to consider it walking
            isMoving = false;
            UpdateAnimation(false);
        }
