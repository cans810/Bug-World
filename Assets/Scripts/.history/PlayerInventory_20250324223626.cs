...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void OnLevelChanged(int newLevel)
    {
        ...
        maxChitinCapacity += 15;
        maxCrumbCapacity += 2;
        
        // Trigger UI updates for chitin and crumb capacity changes
        OnChitinCountChanged?.Invoke(_chitinCount);  // This will update the chitin UI with new capacity
        OnCrumbCountChanged?.Invoke(_crumbCount);    // This will update the crumb UI with new capacity
