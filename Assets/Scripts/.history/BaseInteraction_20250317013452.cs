...
public class BaseInteraction : MonoBehaviour
{
    ...
    private void DepositPlayerCrumbs()
    {
        ...
        // Allow deposit at any amount, not just when full
        if (currentCrumbs > 0)
        {
            ...
            if (visualEffectManager != null)
            {
                ...
                StartCoroutine(visualEffectManager.SpawnCrumbCollectEffect(currentCrumbs, hasEquippedEntity));
            }
            ...
            if (antIncubator != null && !hasEquippedEntity)
            {
                ...
                // Notice we removed the check for having enough crumbs - deposit any amount
                ...
                else
                {
                    ...
                    if (showDebugMessages)
                    {
                        Debug.Log($"Not enough crumbs ({currentCrumbs}/{requiredCrumbs}) for egg creation. Crumbs stored.");
                    }
                }
            }
