...
public class PlayerController : MonoBehaviour
{
    ...
    private bool forceInputPoll = false;
    ...
    private IEnumerator ReviveAfterDelay(float delay, bool restoreAutoAttack = true)
    {
        ...
        // Force the player to respond to input
        forceInputPoll = true;
    ...
    private void HandleInput()
    {
        ...
        // If forceInputPoll is true, poll for direct keyboard input regardless of other input
        if (forceInputPoll)
        {
            ...
            // Reset after one frame of successful input
            if (Mathf.Abs(horizontalInput) > 0.1f || Mathf.Abs(verticalInput) > 0.1f)
            {
                forceInputPoll = false;
            }
        }
