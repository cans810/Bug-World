    ...
    private IEnumerator WanderingRoutine()
    {
        while (true)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                // Use a shorter distance for the "too close" check
                if (IsBorderInDirection(rayDir, borderDetectionDistance * 0.75f))
                {
                    ...
                    Debug.DrawRay(transform.position, rayDir * borderDetectionDistance * 0.75f, Color.red, 3f);
                }
            }
