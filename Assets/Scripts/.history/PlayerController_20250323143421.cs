...
public class PlayerController : MonoBehaviour
{
    ...
    private void HandlePlayerDeath()
    {
        ...
        // Clear the enemies in range list when player dies
    ...
    // Also add this method to ensure enemies are properly cleared when respawning
    public void ResetAfterRespawn()
    {
        // Clear any lingering enemies in range
        enemiesInRange.Clear();
        
        // Ensure auto-attack is stopped
        if (autoAttackCoroutine != null)
        {
            StopCoroutine(autoAttackCoroutine);
            autoAttackCoroutine = null;
        ...
        Debug.Log("PlayerController: Reset after respawn - cleared enemies and stopped auto-attack");
    }
}