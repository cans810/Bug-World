...
public class VisualEffectManager : MonoBehaviour
{
    ...
    {
        // Calculate screen position for top left corner (for UI XP counter)
        Vector2 screenTopLeft = new Vector2(xpTargetOffsetX, Screen.height - xpTargetOffsetY);
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Vector3 spawnPos = nestPosition + new Vector3(randomOffset.x, xpSymbolSpawnOffsetY, randomOffset.y);
    ...
    private IEnumerator AnimateXPSymbol(GameObject symbol, Vector2 targetScreenPos)
    {
        ...
        midPoint += Vector3.up * Random.Range(1f, 2f);
