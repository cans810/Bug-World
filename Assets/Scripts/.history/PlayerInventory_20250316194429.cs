...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void TriggerXPDisplayUpdate(int amount)
    {
        ...
        // Debug log
        Debug.Log($"XP display updated with {amount} XP. Total: {_experience}");
    }

    // Modify the DepositChitin method to use the new visual effect system
    public void DepositChitin(int amount)
    {
        ...
        if (visualEffectManager != null)
        {
            ...
            // We don't add experience here anymore - it will be added when the first symbol reaches its destination
        }
        else
        {
            // Fallback if visual effect manager is not available
            Experience += xpGain;
        }
