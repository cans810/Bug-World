...
public class PlayerAttributes : MonoBehaviour
{
    ...
    {
        // Log the current value before adding
        Debug.Log($"PlayerAttributes.AddAttributePoints: Before adding, availablePoints = {availablePoints}");
        
        // Add the points
        availablePoints += pointsToAdd;
        
        // Log the new value after adding
        Debug.Log($"PlayerAttributes.AddAttributePoints: After adding {pointsToAdd}, availablePoints = {availablePoints}");
