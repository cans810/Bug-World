...
public class LevelUpPanelHelper : MonoBehaviour
{
    ...
    public void UpdateChitinRewardText(){
        chitinCapacityReward.transform.Find("RewardText").GetComponent<TextMeshProUGUI>().text = "+10";
    }

    public void UpdateCrumbRewardText(){
        crumbCapacityReward.transform.Find("RewardText").GetComponent<TextMeshProUGUI>().text = "+1";
    }

    public void UpdateAttributeRewardText(){
        attributePointReward.transform.Find("RewardText").GetComponent<TextMeshProUGUI>().text = "+2";
    }
    ...
    private void OnEnable()
    {
        ...
        if (playerInventory != null)
        {
            ...
            Debug.Log("Subscribed to player level up events");
        }
    }
    ...
    private void HandleLevelUp(int newLevel)
    {
        ...
        Debug.Log($"Handling level up to level {newLevel}");
