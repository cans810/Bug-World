...
public class VisualEffectManager : MonoBehaviour
{
    ...
    public IEnumerator SpawnCrumbCollectEffect(int count)
    {
        ...
        if (canvas == null)
        {
            Debug.LogError("Cannot spawn crumb effect - Canvas not found");
            yield break;
        }
        
        // Use screen position for crumb panel
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Vector2 randomOffset = Random.insideUnitCircle * spreadRadius;
            Vector2 spawnScreenPos = screenTopLeft + randomOffset;
            ...
            // Start animated collection - use the same UI animation method
            StartCoroutine(AnimateResourceCollectionInUI(symbol, "crumb"));
