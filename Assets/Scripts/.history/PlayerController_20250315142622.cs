...
public class PlayerController : MonoBehaviour
{
    ...
    // First, let's fix the animation parameter issue in the OnAttackButtonPressed method
    public bool OnAttackButtonPressed()
    {
        ...
        if (livingEntity != null)
        {
            ...
            if (attackResult)
            {
                // Check if the walkAttack animation exists before trying to use it
                if (isWalking && animController != null)
                {
                    // Try using SetWalking(true) and SetAttacking(true) instead if SetWalkAttacking doesn't exist
                    try {
                        ...
                        // Fallback if SetWalkAttacking doesn't exist
