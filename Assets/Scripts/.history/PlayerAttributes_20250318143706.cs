...
public class PlayerAttributes : MonoBehaviour
{
    ...
    public void LoadPlayerAttributes(GameData gameData)
    {
        if (gameData == null)
        {
            Debug.LogError("Cannot load attributes: GameData is null");
            return;
        }
        
        Debug.Log("Loading attribute data into PlayerAttributes");
        
        // Load attribute values directly
        strength.points = gameData.currentStrength;
        vitality.points = gameData.currentVitality;
        agility.points = gameData.currentAgility;
        incubationPoints = gameData.currentIncubation;
        availablePoints = gameData.availableAttributePoints;
        
        // Apply the loaded attributes
        ApplyAttributeEffects();
        
        Debug.Log($"PlayerAttributes loaded: Strength={strength.points}, Vitality={vitality.points}, " +
                  $"Agility={agility.points}, Incubation={incubationPoints}, Available={availablePoints}");
    }
