...
public class AllyEggController : MonoBehaviour
{
    ...
    // Add or update this method in AllyEggController to properly enable both AI components
    public void OnHatchingComplete(GameObject insect)
    {
        ...
        // Notify any other systems that need to know about the new ally
        GlobalEventManager.Instance?.NotifyAllyCreated(insect);
    }
}
