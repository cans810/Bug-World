...
public class UIHelper : MonoBehaviour
{
    ...
    // Add this method to UIHelper.cs
    public void ShowLevelUpRewardsText()
    {
        // Skip showing messages if we're loading data
        PlayerInventory playerInventory = FindObjectOfType<PlayerInventory>();
        if (playerInventory != null && playerInventory.IsLoadingData)
        ...
        if (onLevelUpThingsGainedText != null)
        {
            ...
            onLevelUpThingsGainedText.text = "+15 Chitin Capacity\n+15 Crumb Capacity\n+1 Attribute Point";
            
            // Make the text visible
            onLevelUpThingsGainedText.gameObject.SetActive(true);
        ...
        {
            Debug.LogWarning("Level-up rewards text component is null!");
        }
    }
    ...
    {
        yield return new WaitForSeconds(delay);
        HideLevelUpRewardsText();
    }

    public void HideLevelUpRewardsText()
    {
        if (onLevelUpThingsGainedText != null)
        {
            // Hide the text
            onLevelUpThingsGainedText.gameObject.SetActive(false);
            onLevelUpThingsGainedText.text = "";
        }
    }
} 
