...
public class AnimationController : MonoBehaviour
{
    ...
    // Overload the method to accept a boolean parameter
    public void SetDead(bool isDead)
    {
        if (isDead)
        {
            SetDead(); // Call the existing implementation for true
        }
        else
        {
            // Handle un-death state if needed
            // This might reset death animations, etc.
        }
    }
