...
public class LivingEntity : MonoBehaviour
{
    ...
    [SerializeField] private float sinkingDuration = 3.5f;  // Increased to 3.5 seconds
    [SerializeField] private float sinkingDelay = 0.5f;     // Initial pause before sinking starts
    [SerializeField] private float sinkingDepth = 1.5f;     
    [SerializeField] private float finalPauseDelay = 0.3f;  // Pause at the end before destroying
