...
public class PlayerInventory : MonoBehaviour
{
    ...
    private IEnumerator PlayBarrierRemovalAnimation(BarrierRocksController barrier)
    {
        ...
        Debug.Log($"<color=cyan>Moving camera to wide view position: {wideViewPosition}</color>");
        ...
        // Short pause before the rocks start disappearing
        yield return new WaitForSeconds(0.8f);
        
        // Trigger rock barrier removal
        Debug.Log("<color=cyan>Triggering rock barrier removal animation</color>");
        barrier.RemoveBarrier();
        
        // Wait for rock disappear animation
