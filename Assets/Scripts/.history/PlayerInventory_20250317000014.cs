...
public class PlayerInventory : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Subscribe to events
        OnChitinCountChanged += UpdateChitinDisplay;
        OnCrumbCountChanged += UpdateCrumbDisplay;
        OnExperienceChanged += UpdateExperienceDisplay;
        OnLevelUp += OnPlayerLevelUp;
        OnCoinCountChanged += UpdateCoinDisplay;
    }
