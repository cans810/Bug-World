...
public class LivingEntity : MonoBehaviour
{
    ...
    private void RecordEntityDiscovery()
    {
        ...
        {
            // Use the correct method to record the discovery - DiscoverEntityOnKill
            entitiesController.DiscoverEntityOnKill(entityType);
            
            // Log the discovery for debugging
            Debug.Log($"Discovered entity through kill: {entityType}");
            
            // The DiscoverEntityOnKill method already handles saving via GameManager, so no need to do it here
        }
    }
}