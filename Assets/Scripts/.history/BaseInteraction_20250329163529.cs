...
public class BaseInteraction : MonoBehaviour
{
    ...
    private IEnumerator PlayXPGainAfterChitinDeposit(int xpAmount, int startXP, int targetXP)
    {
        ...
        if (visualEffectManager != null)
        {
            ...
            if (playerInventory != null)
            {
                // Use AddXP instead of AddExperience to ensure proper handling
                playerInventory.AddExperienceGradually(xpAmount, startXP, targetXP);
            }
        }
        else
        {
    ...
    // Update the ProcessChitinDeposit method to pass correct values to our animation
    private void ProcessChitinDeposit(int chitinCount)
    {
        if (playerInventory == null) return;
        
        // Calculate XP amount
        int experiencePerChitin = 1; // Replace with your actual value
        ...
        if (uiHelper != null)
        {
            uiHelper.UpdateChitinDisplay(0, false);
        }
    }
} 