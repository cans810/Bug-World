...
public class PlayerAttributes : MonoBehaviour
{
    ...
    [SerializeField] public AttributeStat recovery = new AttributeStat
    {
        name = "Recovery",
        points = 0,
        percentagePerPoint = 500f
    };
    
    [Header("Incubation")]
    [SerializeField] public int incubationPoints = 0;
    [SerializeField] public int maxIncubationPoints = 20; // Changed from 5 to 20
    ...
    [SerializeField] public int pointsPerLevel = 1;
    ...
    {
        if (availablePoints <= 0 || recovery.points >= 100)
            return false;
        ...
        Debug.Log($"Increased Recovery to {recovery.points}/100. Recovery multiplier: {recovery.GetMultiplier():F2}x");
        return true;
    }
