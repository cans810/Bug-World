...
public class EntityGenerator : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        if (useBoxShape)
        {
            // Draw the box area visualization
        ...
        else
        {
            ...
            Gizmos.color = gizmoColor;
            DrawWireSphere(center, spawnRadius);
        }
    ...
    // Helper method to draw a wire sphere (since we can't use DrawWireSphere if we're in a custom matrix)
