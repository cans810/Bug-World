...
public class EnemyAI : MonoBehaviour
{
    ...
    private void HandleDeath()
    {
        ...
        // Stop all coroutines that might cause movement
        StopAllCoroutines();
        
        // Force the rigidbody to be kinematic and zero out velocities
        ...
        // Ensure the animation is set to idle/death
        if (animController != null)
        {
        ...
        // Finally disable this component
        enabled = false;
    }
