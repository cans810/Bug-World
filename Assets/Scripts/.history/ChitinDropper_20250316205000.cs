...
public class ChitinDropper : MonoBehaviour
{
    ...
    private void SpawnChitinWithPhysics()
    {
        ...
        // Apply MUCH stronger upward force for a high arch
        float upwardForce = Random.Range(5.0f, 8.0f); // Increased from 2-4 to 5-8
        
        // Apply minimal horizontal force for slight spread
        Vector2 randomDirection = Random.insideUnitCircle.normalized;
        Vector3 horizontalForce = new Vector3(
            randomDirection.x,
            0,
            randomDirection.y
        ) * Random.Range(0.5f, 1.5f); // Reduced horizontal force
