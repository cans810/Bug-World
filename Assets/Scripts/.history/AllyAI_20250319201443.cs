...
public class AllyAI : MonoBehaviour
{
    ...
    // Add this field to track movement application per frame
    private bool hasAppliedMovementThisFrame = false;
    
    // Add the public property that AIWandering.cs is looking for
    ...
    private void MoveToPosition(Vector3 position)
    {
        ...
        if (distance > 0.3f)
        {
            ...
            if (livingEntity != null)
            {
                ...
                hasAppliedMovementThisFrame = true; // Set the flag when movement is applied
            }
            else
            {
