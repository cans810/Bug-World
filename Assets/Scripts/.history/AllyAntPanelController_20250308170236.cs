...
public class AllyAntPanelController : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI allAntsFollowModeOrderText; // Text showing current order/state

    [SerializeField] private Button allAntswanderModeToggle;
    [SerializeField] private TextMeshProUGUI allAntsWanderModeOrderText; // Text showing current order/state

    [SerializeField] private Button allAntslootModeToggle;
    [SerializeField] private TextMeshProUGUI allAntsLootModeOrderText; // Text showing current order/state
