...
public class CameraAnimations : MonoBehaviour
{
    ...
    [SerializeField] private float mapViewHeight = 60f; // Height above ground for map view
    [SerializeField] private float mapViewDuration = 1.5f; // Time to transition to map view
    [SerializeField] private float mapCameraAngle = 75f; // Near top-down view (75-80 degrees)
