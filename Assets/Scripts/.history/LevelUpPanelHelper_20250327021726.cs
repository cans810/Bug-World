...
public class LevelUpPanelHelper : MonoBehaviour
{
    ...
    {
        // Use the animator state or active state to determine if panel is showing
        Animator animator = GetComponent<Animator>();
        if (animator != null)
        {
            return animator.GetBool("ShowUp") && !animator.GetBool("Hide");
        }
        
        // Fallback to just checking if active
