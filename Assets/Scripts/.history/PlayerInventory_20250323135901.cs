...
public class PlayerInventory : MonoBehaviour
{
    ...
    private IEnumerator PlayBarrierRemovalAnimation(BarrierRocksController barrier)
    {
        ...
        // Calculate viewing position - higher and back for good view
        Vector3 viewPosition = barrierPosition - (barrierPosition - playerTransform.position).normalized * 12f + Vector3.up * 8f;
        ...
        // STEP 1: Move camera to view position
        ...
        // STEP 5: Move camera back to player
        ...
        // Make sure camera is exactly back at original position
